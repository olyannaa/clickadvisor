...
ClickStack Cloud をお試しになりたい方は、プレビュープログラムにご登録ください。[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-754-clickstack-cloud-sign-up&utm_blogctaid=754)## なぜ ClickStack Cloud なのか [\#](/jp/blog/clickstack-cloud-private-preview-jp#why-clickstack-cloud)
...
## OpenTelemetry データを送るだけで、すぐに観測を開始 [\#](/jp/blog/clickstack-cloud-private-preview-jp#send-opentelemetry-data-start-observing)
...
4    headers:
5      authorization: Bearer ${CLICKSTACK_CLOUD_TOKEN}
```
...
## OpenTelemetry のためのフルマネージドな取り込み層 [\#](/jp/blog/clickstack-cloud-private-preview-jp#a-fully-managed-ingestion-layer-for-opentelemetry)
...
## プライベートプレビュー期間中に取り組むこと [\#](/jp/blog/clickstack-cloud-private-preview-jp#what-we-are-building-during-private-preview)
...
## オブザーバビリティワークロードの自動チューニング [\#](/jp/blog/clickstack-cloud-private-preview-jp#automatic-tuning-for-observability-workloads)
...
## エージェント型オブザーバビリティワークロードに対応する設計 [\#](/jp/blog/clickstack-cloud-private-preview-jp#built-for-agentic-observability-workloads)
...
## ClickStack Cloud が想定するユーザー [\#](/jp/blog/clickstack-cloud-private-preview-jp#who-clickstack-cloud-is-for)
...
## プライベートプレビューに参加する [\#](/jp/blog/clickstack-cloud-private-preview-jp#join-the-private-preview)
