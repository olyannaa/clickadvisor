# Precreate parts using clickhouse\-local \| Altinity® Knowledge Base for ClickHouse®


1. [Setup \& maintenance](/altinity-kb-setup-and-maintenance/)
2. Precreate parts using clickhouse\-local
...
```
Last modified 2023\.08\.15: [Update precreate\_parts\_using\_clickhouse\_local.sh.md (e11b167\)](https://github.com/Altinity/altinityknowledgebase/commit/e11b1671901cec72e3ee5c4eb53e456856a90195)
