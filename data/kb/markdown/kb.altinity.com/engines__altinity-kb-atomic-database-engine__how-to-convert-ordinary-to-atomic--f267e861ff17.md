# How to Convert Ordinary to Atomic \| Altinity® Knowledge Base for ClickHouse®


1. [Engines](/engines/)
2. [Atomic Database Engine](/engines/altinity-kb-atomic-database-engine/)
3. How to Convert Ordinary to Atomic
...
```
Last modified 2025\.01\.28: [detached parts failure (4e891ec)](https://github.com/Altinity/altinityknowledgebase/commit/4e891ec99ac9106b7d68fcd77a91b21ef09d3a42)
