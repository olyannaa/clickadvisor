# Ingestion metrics from system.part\_log \| Altinity® Knowledge Base for ClickHouse®


1. [Useful queries](/altinity-kb-useful-queries/)
2. Ingestion metrics from system.part\_log
# Ingestion metrics from system.part\_log
