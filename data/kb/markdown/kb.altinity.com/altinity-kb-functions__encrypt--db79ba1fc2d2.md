# Encrypt \| Altinity® Knowledge Base for ClickHouse®
...
Because encryption and decryption can be expensive due re\-initialization of keys and iv, usually it make sense to use those functions over literal values instead of table column.Last modified 2021\.08\.24: [Update encrypt.md (98c3973\)](https://github.com/Altinity/altinityknowledgebase/commit/98c3973a72a8775e8aafb083c61879f2eace6154)
