# Remove block numbers from zookeeper for removed partitions \| Altinity® Knowledge Base for ClickHouse®


1. [Useful queries](/altinity-kb-useful-queries/)
2. Remove block numbers from zookeeper for removed partitions
