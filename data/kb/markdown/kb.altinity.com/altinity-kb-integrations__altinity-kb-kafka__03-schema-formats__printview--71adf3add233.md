...
[Return to the regular view of this page](/altinity-kb-integrations/altinity-kb-kafka/03-schema-formats/).

# Schema and Formats

Schema inference and format\-specific integration details.- 1: [Inferring Schema from AvroConfluent Messages in Kafka for ClickHouse®](#pg-150cd8aebb4a61016c1041f0416a3535)
