# Inferring Schema from AvroConfluent Messages in Kafka for ClickHouse® \| Altinity® Knowledge Base for ClickHouse®


1. [Integrations](/altinity-kb-integrations/)
2. [Kafka engine](/altinity-kb-integrations/altinity-kb-kafka/)
3. [Schema and Formats](/altinity-kb-integrations/altinity-kb-kafka/03-schema-formats/)
4. Schema Inference for Kafka
