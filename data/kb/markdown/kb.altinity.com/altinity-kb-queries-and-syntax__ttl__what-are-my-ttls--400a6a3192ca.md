# What are my TTL settings? \| Altinity® Knowledge Base for ClickHouse®


1. [Queries \& Syntax](/altinity-kb-queries-and-syntax/)
2. [TTL](/altinity-kb-queries-and-syntax/ttl/)
3. What are my TTL settings
...
```
Last modified 2022\.03\.27: [Update what\-are\-my\-ttls.md (6cbffeb)](https://github.com/Altinity/altinityknowledgebase/commit/6cbffeb8b0ca31471663ad1676da9d5b57531754)
