...
##### [ReplacingMergeTree does not collapse duplicates](/engines/mergetree-table-engine-family/replacingmergetree/altinity-kb-replacingmergetree-does-not-collapse-duplicates/)
