# UNDROP TABLE \| ClickHouse Docs


- - [Introduction](/docs/sql-reference)- [Statements](/docs/sql-reference/statements)- UNDROP
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/undrop.md)# UNDROP TABLE
...
TipAlso see [DROP TABLE](/docs/sql-reference/statements/drop)
...
```
[PreviousCHECK GRANT](/docs/sql-reference/statements/check-grant)[NextOperators](/docs/sql-reference/operators)Was this page helpful?
