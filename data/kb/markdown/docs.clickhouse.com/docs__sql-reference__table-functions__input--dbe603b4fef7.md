...
- - [Functions](/docs/sql-reference/functions)- [Table functions](/docs/sql-reference/table-functions)- input
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/table-functions/input.md)# input
...
Data can be sent in any way like for ordinary `INSERT` query and passed in any available [format](/docs/sql-reference/formats)
...
```
[PreviouspaimonCluster](/docs/sql-reference/table-functions/paimonCluster)[Nextjdbc](/docs/sql-reference/table-functions/jdbc)- [Examples](#examples)
