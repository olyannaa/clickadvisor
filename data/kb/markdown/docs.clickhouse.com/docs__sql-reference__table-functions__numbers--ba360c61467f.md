# numbers \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Table functions](/docs/sql-reference/table-functions)- numbers
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/table-functions/numbers.md)# numbers
...
This is similar to the [`system.numbers`](/docs/operations/system-tables/numbers) system table. It can be used for testing and generating successive values.
