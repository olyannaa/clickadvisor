# lagInFrame \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Window functions](/docs/sql-reference/window-functions)- lagInFrame
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/window-functions/lagInFrame.md)# lagInFrame
...
Note`lagInFrame` behavior differs from the standard SQL `lag` window function.
