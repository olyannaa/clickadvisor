...
- - [Performance and optimizations](/docs/operations/overview)- Avoid optimize final
[Edit this page](https://github.com/ClickHouse/clickhouse-docs/blob/main/docs/guides/best-practices/avoidoptimizefinal.md)# Avoid optimize final
...
[PreviousAvoid nullable columns](/docs/optimize/avoid-nullable-columns)[NextAnalyzer](/docs/operations/analyzer)- [Why avoid?](#why-avoid)
