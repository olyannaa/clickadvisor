# rank \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Window functions](/docs/sql-reference/window-functions)- rank
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/window-functions/rank.md)# rank
...
The [dense\_rank](/docs/sql-reference/window-functions/dense_rank) function provides the same behaviour but without gaps in ranking.
...
- A number for the current row within its partition, including gaps. [UInt64](/docs/sql-reference/data-types/int-uint).
...
```
[Previousnth\_value](/docs/sql-reference/window-functions/nth_value)[Nextdense\_rank](/docs/sql-reference/window-functions/dense_rank)Was this page helpful?
