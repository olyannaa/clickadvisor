...
- - [Best practices](/docs/best-practices)- Avoid mutations
[Edit this page](https://github.com/ClickHouse/clickhouse-docs/blob/main/docs/best-practices/avoid_mutations.md)# Avoid mutations
