# sumMap \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Aggregate functions](/docs/sql-reference/aggregate-functions)- [Aggregate Functions](/docs/sql-reference/aggregate-functions/reference)- sumMap
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/sumMappedArrays.md)# sumMap

## sumMappedArrays[​](#sumMappedArrays "Direct link to sumMappedArrays")
...
- `value1, value2, ...` — Arrays of values to sum for each key. [`Array`](/docs/sql-reference/data-types/array)


**Returned value**


Returns a tuple of arrays: the first array contains keys in sorted order, followed by arrays containing values summed for the corresponding keys. [`Tuple`](/docs/sql-reference/data-types/tuple)
