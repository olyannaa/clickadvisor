...
- - [Functions](/docs/sql-reference/functions)- [Window functions](/docs/sql-reference/window-functions)- lag
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/window-functions/lag.md)# lag
...
This function is similar to [`lagInFrame`](/docs/sql-reference/window-functions/lagInFrame), but always uses the `ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING` frame.
...
```
[Previouspercent\_rank](/docs/sql-reference/window-functions/percent_rank)[NextlagInFrame](/docs/sql-reference/window-functions/lagInFrame)Was this page helpful?
