...
This means at some point in time, Bitcoin and Ethereum traded above 100,andDOGEFIandBitcoinDiamondhavenevertradedabove100, and DOGEFI and Bitcoin Diamond have never traded above 100,andDOGEFIandBitcoinDiamondhavenevertradedabove100 (at least using the data we have here in this example).


## INTERSECT DISTINCT[​](#intersect-distinct "Direct link to INTERSECT DISTINCT")
