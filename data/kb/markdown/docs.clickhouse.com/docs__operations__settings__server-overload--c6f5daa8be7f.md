# Server overload \| ClickHouse Docs


- - [Settings](/docs/operations/settings)- Server overload
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/operations/settings/server-overload.md)# Server overload
...
## Rejecting queries[​](#rejecting-queries "Direct link to Rejecting queries")
...
## Dropping connections[​](#dropping-connections "Direct link to Dropping connections")
...
## Resource overload warnings[​](#resource-overload-warnings "Direct link to Resource overload warnings")
...
```
[PreviousRestrictions on query complexity](/docs/operations/settings/query-complexity)[NextQuery\-level Session Settings](/docs/operations/settings/query-level)- [Overview](#overview)- [Rejecting queries](#rejecting-queries)- [Dropping connections](#dropping-connections)- [Resource overload warnings](#resource-overload-warnings)
