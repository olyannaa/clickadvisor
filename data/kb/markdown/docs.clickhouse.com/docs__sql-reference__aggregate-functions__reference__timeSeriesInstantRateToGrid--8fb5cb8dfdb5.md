# timeSeriesInstantRateToGrid \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Aggregate functions](/docs/sql-reference/aggregate-functions)- [Aggregate Functions](/docs/sql-reference/aggregate-functions/reference)- timeSeriesInstantRateToGrid
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/timeSeriesInstantRateToGrid.md)# timeSeriesInstantRateToGrid

## timeSeriesInstantRateToGrid[​](#timeSeriesInstantRateToGrid "Direct link to timeSeriesInstantRateToGrid")
...
Returns irate values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if there are not enough samples within the window to calculate the instant rate value for a particular grid point. [`Array(Nullable(Float64))`](/docs/sql-reference/data-types/array)
...
```
[PrevioustimeSeriesInstantDeltaToGrid](/docs/sql-reference/aggregate-functions/reference/timeSeriesInstantDeltaToGrid)[NexttimeSeriesLastTwoSamples](/docs/sql-reference/aggregate-functions/reference/timeSeriesLastTwoSamples)- [timeSeriesInstantRateToGrid](#timeSeriesInstantRateToGrid)
