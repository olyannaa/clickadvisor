# timeSeriesDeltaToGrid \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Aggregate functions](/docs/sql-reference/aggregate-functions)- [Aggregate Functions](/docs/sql-reference/aggregate-functions/reference)- timeSeriesDeltaToGrid
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/timeSeriesDeltaToGrid.md)# timeSeriesDeltaToGrid

## timeSeriesDeltaToGrid[​](#timeSeriesDeltaToGrid "Direct link to timeSeriesDeltaToGrid")
...
Returns delta values on the specified grid. The returned array contains one value for each time grid point. The value is NULL if there are not enough samples within the window to calculate the delta value for a particular grid point. [`Array(Nullable(Float64))`](/docs/sql-reference/data-types/array)
...
```
[PrevioustimeSeriesChangesToGrid](/docs/sql-reference/aggregate-functions/reference/timeSeriesChangesToGrid)[NexttimeSeriesDerivToGrid](/docs/sql-reference/aggregate-functions/reference/timeSeriesDerivToGrid)- [timeSeriesDeltaToGrid](#timeSeriesDeltaToGrid)
