...
- - [Performance and optimizations](/docs/operations/overview)- Bulk inserts
[Edit this page](https://github.com/ClickHouse/clickhouse-docs/blob/main/docs/guides/best-practices/bulkinserts.md)# Bulk inserts
...
[PreviousLazy materialization](/docs/optimize/lazy-materialization)[NextAsynchronous inserts](/docs/optimize/asynchronous-inserts)Was this page helpful?
