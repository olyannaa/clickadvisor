...
- - [Settings](/docs/operations/settings)- Settings profiles
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/operations/settings/settings-profiles.md)# Settings profiles

A settings profile is a collection of settings grouped under the same name.


NoteClickHouse also supports [SQL\-driven workflow](/docs/operations/access-rights#access-control-usage) for managing settings profiles. We recommend using it.
...
[PreviousQuery\-level Session Settings](/docs/operations/settings/query-level)[NextUser Settings](/docs/operations/settings/settings-users)Was this page helpful?
