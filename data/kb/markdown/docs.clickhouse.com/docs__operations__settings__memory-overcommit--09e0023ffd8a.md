...
- - [Settings](/docs/operations/settings)- Memory overcommit
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/operations/settings/memory-overcommit.md)# Memory overcommit
...
If overcommit tracker can't choose query to stop, MEMORY\_LIMIT\_EXCEEDED exception is thrown.


## User overcommit tracker[​](#user-overcommit-tracker "Direct link to User overcommit tracker")
...
## Global overcommit tracker[​](#global-overcommit-tracker "Direct link to Global overcommit tracker")
...
[PreviousConstraints on settings](/docs/operations/settings/constraints-on-settings)[NextPermissions for queries](/docs/operations/settings/permissions-for-queries)- [User overcommit tracker](#user-overcommit-tracker)- [Global overcommit tracker](#global-overcommit-tracker)
