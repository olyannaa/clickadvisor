# cume\_dist \| ClickHouse Docs


- - [Functions](/docs/sql-reference/functions)- [Window functions](/docs/sql-reference/window-functions)- cume\_dist
[Edit this page](https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/window-functions/cume_dist.md)# cume\_dist
...
- The relative rank of the current row. The return type is Float64 in the range \[0, 1]. [Float64](/docs/sql-reference/data-types/float).
...
[PreviousleadInFrame](/docs/sql-reference/window-functions/leadInFrame)[NextView all formats...](/docs/interfaces/formats)Was this page helpful?
