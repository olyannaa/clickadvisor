# Choose a low cardinality partitioning key \| ClickHouse Docs


- - [Performance and optimizations](/docs/operations/overview)- Partitioning key
[Edit this page](https://github.com/ClickHouse/clickhouse-docs/blob/main/docs/guides/best-practices/partitioningkey.md)# Choose a low cardinality partitioning key
...
[PreviousQuery parallelism](/docs/optimize/query-parallelism)[NextData skipping indexes](/docs/optimize/skipping-indexes)- [Applications of partitioning](#applications-of-partitioning)- [Choose a low cardinality partitioning key](#choose-a-low-cardinality-partitioning-key)
