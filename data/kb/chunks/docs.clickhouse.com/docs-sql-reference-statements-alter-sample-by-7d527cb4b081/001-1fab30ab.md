...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/alter/sample-by.md)#
topic: manipulating-sampling-key-expressions-clickhouse-docs
