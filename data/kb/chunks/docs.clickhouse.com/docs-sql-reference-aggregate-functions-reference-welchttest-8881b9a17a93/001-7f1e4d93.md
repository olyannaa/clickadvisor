...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/welchTTest.md)#
topic: welchttest-clickhouse-docs
ch_version_introduced: '20.3'
