...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/table-functions/timeSeriesMetrics.md)#
topic: timeseriesmetrics-clickhouse-docs
