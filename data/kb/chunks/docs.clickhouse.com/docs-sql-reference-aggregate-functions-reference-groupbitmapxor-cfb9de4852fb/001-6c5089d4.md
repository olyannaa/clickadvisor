...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/groupBitmapXor.md)#
topic: groupbitmapxor-clickhouse-docs
