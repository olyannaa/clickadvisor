...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/alter/apply-patches.md)#
topic: apply-patches-from-lightweight-updates-clickhouse-docs
