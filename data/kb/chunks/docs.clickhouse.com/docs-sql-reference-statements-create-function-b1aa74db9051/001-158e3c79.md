...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/create/function.md)#
topic: create-function-user-defined-function-udf-clickhouse-docs
