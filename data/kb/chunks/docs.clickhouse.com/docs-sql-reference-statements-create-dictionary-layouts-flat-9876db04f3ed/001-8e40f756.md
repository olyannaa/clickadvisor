...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/create/dictionary/layouts/flat.md)#
topic: flat-dictionary-layout-clickhouse-docs
