...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/deltaSumTimestamp.md)#
topic: deltasumtimestamp-clickhouse-docs
