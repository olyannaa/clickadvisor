...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/timeSeriesRateToGrid.md)#
topic: timeseriesratetogrid-clickhouse-docs
ch_version_introduced: '0.06666667'
