...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/create/named-collection.md)Not
topic: create-named-collection-clickhouse-docs
