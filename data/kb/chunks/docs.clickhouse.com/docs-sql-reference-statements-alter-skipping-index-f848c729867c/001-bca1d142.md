...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/statements/alter/skipping-index.md)#
topic: manipulating-data-skipping-indices-clickhouse-docs
