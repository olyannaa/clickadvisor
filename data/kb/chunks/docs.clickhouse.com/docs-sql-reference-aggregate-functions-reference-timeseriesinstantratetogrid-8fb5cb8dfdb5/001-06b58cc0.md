...
url: https://github.com/ClickHouse/ClickHouse/tree/master/docs/en/sql-reference/aggregate-functions/reference/timeSeriesInstantRateToGrid.md)#
topic: timeseriesinstantratetogrid-clickhouse-docs
