...
exercising the database’s real\-time analytics capabilities. Wix teams can now compose, test, and iterate on SQL queries directly inside Wild Moose agents, where those queries are executed automatically during incidents. ### 2\. Query performance enables parallel investigations \#
