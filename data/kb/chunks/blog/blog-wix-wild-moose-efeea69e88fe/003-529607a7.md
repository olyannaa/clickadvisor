...
investigate, not as a black box - It must integrate into existing workflows (Slack, Grafana, logs) - It needs to automate tribal knowledge without replacing human judgment - And it must scale without disrupting human access to data
