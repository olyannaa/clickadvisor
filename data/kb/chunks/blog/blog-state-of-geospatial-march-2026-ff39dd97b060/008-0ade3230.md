...
the coordinates using `.1` (longitude) and `.2` (latitude): ``` 1WITH 2 (-0.12, 51.5)::Point AS london, 3 (2.35, 48.86)::Point AS paris 4SELECT greatCircleDistance(london.1, london.2, paris.1, paris.2); ``` Copy command This will return the same output as the previous query.
...
```
1┌─geoDistance(⋯.35, 48.86)─┐
2│       342580.40445145103 │
3└──────────────────────────┘
```
Copy command
...
```
1┌──────────area_m2─┬──────────area_km2─┬───────perimeter_m─┐
2│ 76885325.3526875 │ 76.88532535268749 │ 36067.92002218744 │
3└──────────────────┴───────────────────┴───────────────────┘
```
Copy command
