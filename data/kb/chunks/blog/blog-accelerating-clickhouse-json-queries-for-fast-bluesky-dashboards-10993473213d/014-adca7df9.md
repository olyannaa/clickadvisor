...
data_size 4FROM system.parts 5WHERE active AND (database = 'bluesky') AND (table = 'reposts_per_post_top10'); ``` Copy commandRun query Static result for the query above from March 2025: ``` ┌─rows──┬─data_size─┐ │ 10.00 │ 680.00 B │ └───────┴───────────┘ ``` Copy command
...
![Blog-bluesky-faster-v3.011.png](/_next/image?url=%2Fuploads%2FBlog_bluesky_faster_v3_011_69f9dc837a.png&w=2048&q=75)
