...
queries are slow (baseline: 37s execution time) \# Before we address these aforementioned issues—enriching most reposted posts with content and mapping DIDs to user handles—let’s start with a basic query to retrieve the top 10 most reposted posts:
...
![Blog-bluesky-faster.008.png](/_next/image?url=%2Fuploads%2FBlog_bluesky_faster_008_30bd4845a1.png&w=2048&q=75)
