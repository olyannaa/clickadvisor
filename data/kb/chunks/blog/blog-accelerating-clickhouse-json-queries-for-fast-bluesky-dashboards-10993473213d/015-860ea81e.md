...
\# As mentioned earlier, this scenario introduces an additional challenge: the dashboard must display the most reposted Bluesky posts, but repost events contain only post identifiers (CIDs), not the actual post content. ![Blog-bluesky-faster.001.png](/_next/image?url=%2Fuploads%2FBlog_bluesky_faster_001_4295ba4b79.png&w=2048&q=75) We tackle this efficiently by:
...
![Blog-bluesky-faster.010.png](/_next/image?url=%2Fuploads%2FBlog_bluesky_faster_010_f70827c6c9.png&w=2048&q=75)
