...
are active on Bluesky during the day. ### Baseline query: counting events by hour (44s) \# A potential query powering this dashboard calculates the most popular Bluesky event types using a `count` aggregation across the complete Bluesky dataset:
...
![Blog-bluesky-faster.004.png](/_next/image?url=%2Fuploads%2FBlog_bluesky_faster_004_b76e83ba6a.png&w=2048&q=75)
