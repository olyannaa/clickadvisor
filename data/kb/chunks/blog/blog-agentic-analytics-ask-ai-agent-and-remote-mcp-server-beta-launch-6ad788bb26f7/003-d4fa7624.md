...
![image 5 .png](/_next/image?url=%2Fuploads%2Fimage_5_9cbcd1cc6f.png&w=2048&q=75)

*The first 3 months of DWAINE \- Token Counts per Day*

If you want to experience what it looks like, we recommend visiting [llm.clickhouse.com](https://llm.clickhouse.com), our public demonstration agent code\-named [AgentHouse](https://clickhouse.com/blog/agenthouse-demo-clickhouse-llm-mcp), which exposes publicly available datasets via an agentic interface.
