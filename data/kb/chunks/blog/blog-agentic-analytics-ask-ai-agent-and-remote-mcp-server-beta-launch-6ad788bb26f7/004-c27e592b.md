...
possible. This can be achieved by commenting the tables using the SQL [COMMENT](https://clickhouse.com/docs/sql-reference/statements/alter/column#comment-column) syntax for example, or by providing more context in\-line, in the chat, or part of the system prompt of an LLM session. ## Conclusion [\#](/blog/agentic-analytics-ask-ai-agent-and-remote-mcp-server-beta-launch#conclusion)
