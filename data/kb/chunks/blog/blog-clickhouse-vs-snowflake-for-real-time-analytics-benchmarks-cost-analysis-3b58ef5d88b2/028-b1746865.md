...
assumes on\-demand storage pricing for Snowflake. The price per TB is reduced to $20 if storage is pre\-purchased. Assuming the user is able to exploit this, the total cost for storage is estimated as $28\.73\. #### Queries \#
