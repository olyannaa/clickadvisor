...
on ClickHouse 23\.6, unless stated, and in the first 2 weeks of June for Snowflake. #### Summary \# Based on our benchmarking results, we can draw the following conclusions when comparing Snowflake and ClickHouse's performance for this scenario:
