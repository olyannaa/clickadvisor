...
3    count() AS count
4FROM pypi
5WHERE (project = 'typing-extensions') AND (date >= (CAST('2023-06-23', 'Date') - toIntervalDay(90)))
6GROUP BY date
7ORDER BY date ASC
```
Copy command
...
![downloads_by_day_with_cache.png](/_next/image?url=%2Fuploads%2Fdownloads_by_day_with_cache_d2a7bec563.png&w=2048&q=75)
