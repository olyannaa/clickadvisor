...
than ClickHouse Cloud, with Snowflake queries running in tens of seconds, and ClickHouse Cloud queries returning in seconds or less. To bring Snowflake to **comparable query performance, Snowflake is 15x more expensive** than ClickHouse Cloud. #### Assumptions \#
