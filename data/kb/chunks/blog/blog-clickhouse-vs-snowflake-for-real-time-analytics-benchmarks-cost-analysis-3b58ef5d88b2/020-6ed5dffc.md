...
3    count() AS c
4FROM pypi
5WHERE (distro.name = 'Ubuntu') AND (date >= (CAST('2023-06-23', 'Date') - toIntervalDay(90)))
6GROUP BY project
7ORDER BY c DESC
8LIMIT 10
```
...
![top_project_by_distro.png](/_next/image?url=%2Fuploads%2Ftop_project_by_distro_2d84e484c4.png&w=2048&q=75)
...
![top_projects_by_distro.png](/_next/image?url=%2Fuploads%2Ftop_projects_by_distro_1963939ec4.png&w=2048&q=75)
