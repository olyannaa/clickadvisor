...
in separate stores, but unifying the query would provide a single view of which researcher and project spent how many GPU hours, and, as Andrew puts it, "give insights to people on where to prioritize their GPU spend."
...
[Sign up](https://clickhouse.com/cloud/postgres?loc=blog-cta-1326-try-postgres-managed-by-clickhouse-sign-up&utm_blogctaid=1326)### Get started today
