...
this.tradesBatch = []; 27 } else { 28 this.quotesBatch = []; 29 } 30 await this.client.insert({ 31 table: table, 32 values: data, 33 format: "JSONEachRow", 34 }); 35 } ``` Copy command ### Visualize live market data \#
...
![tick-table.png](/_next/image?url=%2Fuploads%2Ftick_table_f21d502995.png&w=2048&q=75)
