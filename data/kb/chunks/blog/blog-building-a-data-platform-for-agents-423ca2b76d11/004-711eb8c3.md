...
and working on custom domain skills, both still in progress but aimed at the same goal: making the assistant context\-aware enough to be genuinely useful for real analytical work, not just SQL generation. ### [ClickHouse Agent Skills](https://clickhouse.com/blog/introducing-clickhouse-agent-skills) \#
