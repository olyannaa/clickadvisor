...
be shaped to serve them well. ### Agent\-friendly docs \# We have applied the same thinking to our documentation. The ClickHouse docs already serve an `llms.txt` file and a docs MCP server is behind our Ask AI feature.
