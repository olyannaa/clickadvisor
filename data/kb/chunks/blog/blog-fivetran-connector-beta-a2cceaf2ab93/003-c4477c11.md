...
ordering key. This means queries filtering on business columns like `customer_name` or `status` could trigger a full table scan. #### Optimising query performance \# There are several ideas that you can use for optimising your read query performance:
