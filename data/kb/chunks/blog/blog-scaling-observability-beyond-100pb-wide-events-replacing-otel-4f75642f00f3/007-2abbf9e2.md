...
This approach is broadly equivalent to a simple bash command: ``` 1curl -s -u 'default:<password>' "https://sql-clickhouse.clickhouse.com:8443/?query=SELECT+*+FROM+system.query_log+FORMAT+Native" | curl -s -X POST --data-binary @- 'http://localhost:8123/?query=INSERT+INTO+query_log+FORMAT+Native' ``` Copy command An actual go implementation for the curious can be found [here](https://pastila.nl/?00740eb5/722157a76fc25f54212d7097b805253b#OSfprbH3wM1dGgtyMAnmuw==).
...
![pipeline.png](/_next/image?url=%2Fuploads%2Fpipeline_9940023a4b.png&w=2048&q=75)
