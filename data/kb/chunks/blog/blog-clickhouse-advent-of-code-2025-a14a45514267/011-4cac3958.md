...
-- Should be 9397 with my input 117FROM part2_solution) 118 119select * from combined_solutions settings use_query_cache=true, query_cache_share_between_users = 1, query_cache_nondeterministic_function_handling = 'save', query_cache_ttl = 80000000, result_overflow_mode = 'throw', read_overflow_mode = 'throw' ``` Copy commandRun query[View full puzzle description](https://adventofcode.com/2025/day/4)
...
```
1SELECT intervalLengthSum(range_tuple.1, range_tuple.2) AS solution
```
Copy command
