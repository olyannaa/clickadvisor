...
We multiplied the volume of each present by its area and summed the results in a single, clean expression. ``` 1arraySum( 2 (volume, area) -> volume * area, 3 requested_shape_volumes, 4 areas_per_shape 5) ``` Copy command **Full Solution:**
...
135FROM solution
```
Copy commandRun query[View full puzzle description](https://adventofcode.com/2025/day/12)
