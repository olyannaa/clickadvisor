...
1' AS part, 155 solution -- 5782351442566 with my input 156FROM part1_solution 157 158UNION ALL 159 160SELECT 161 'Part 2' AS part, 162 solution -- 10194584711842 with my input 163FROM part2_solution; ``` Copy commandRun query[View full puzzle description](https://adventofcode.com/2025/day/6)
...
```
1arrayReduce('sumMap', arrayMap(position -> map(...), ...))
```
Copy command
**Full Solution:**
