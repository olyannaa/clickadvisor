...
1' AS part, 138 solution -- 1633 with my input 139FROM part1_solution 140 141UNION ALL 142 143SELECT 144 'Part 2' AS part, 145 solution -- 34339203133559 with my input 146FROM part2_solution; ``` Copy commandRun query[View full puzzle description](https://adventofcode.com/2025/day/7)
...
```
1runningAccumulate(points_state) AS unique_points_seen
```
Copy command
**Full Solution:**
