...
70 solution -- Should be 361615643045059 with my input 71FROM part2_solution; ``` Copy commandRun query[View full puzzle description](https://adventofcode.com/2025/day/5) --- ## Day 6: The Trash Compactor \# **The Puzzle**: You find a math worksheet with problems arranged in columns.
...
```
1toInt64(arrayProduct(
2    arrayMap(x -> toInt64(x), arraySlice(column, 1, length(column) - 1))
3))
```
Copy command
