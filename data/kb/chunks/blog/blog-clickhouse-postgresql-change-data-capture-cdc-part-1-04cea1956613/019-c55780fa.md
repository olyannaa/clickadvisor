...
pipeline for moving data between Postgres to ClickHouse using Debezium. This includes an introduction to how to track changes in Postgres, Debezium, and the ReplacingMergeTree. These concepts can be combined to produce the following pipeline. ![Final CDC schema.png](/_next/image?url=%2Fuploads%2FFinal_CDC_schema_021b49888b.png&w=2048&q=75)
