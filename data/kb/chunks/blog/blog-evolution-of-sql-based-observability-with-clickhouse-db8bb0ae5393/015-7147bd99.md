...
`system` database `_log` tables. As of today (Nov 2024\), SysEx manages almost 100 Trillion rows and helps our teams efficiently run ClickHouse Cloud. ![syslog.png](/_next/image?url=%2Fuploads%2Fsyslog_2ed4260ce1.png&w=2048&q=75) ## Time series engine \- ClickHouse as a storage engine for Prometheus data \#
...
![5_24_8blog_d62da0e02b](/_next/image?url=%2Fuploads%2F5_24_8blog_d62da0e02b.png&w=2048&q=75)
