...
of receiving the data. The new JSON type addresses all of these challenges, providing an efficient means of supporting dynamically nested structures while retaining precision and the performance associated with statically typed columns. ### Efficient JSON support \#
...
![json_column_per_type.png](/_next/image?url=%2Fuploads%2Fjson_column_per_type_ec55df6761.png&w=2048&q=75)
