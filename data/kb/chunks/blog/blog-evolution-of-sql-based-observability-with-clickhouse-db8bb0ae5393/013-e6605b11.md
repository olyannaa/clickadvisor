...
Null table engine, with a materialized view executing a query on the inserted rows. The results of this view are sent to target tables, which are responsible for serving user queries. ![materialized_views.png](/_next/image?url=%2Fuploads%2Fmaterialized_views_361c981679.png&w=2048&q=75) This has a few clear benefits:
