...
BY ALL 9ORDER BY count() DESC 10LIMIT 10 11SETTINGS 12 use_query_condition_cache = 0, 13 optimize_use_projections = 1; ``` Copy command And again, we’ll run it against each table three times, recording the lowest time and the rows processed:
