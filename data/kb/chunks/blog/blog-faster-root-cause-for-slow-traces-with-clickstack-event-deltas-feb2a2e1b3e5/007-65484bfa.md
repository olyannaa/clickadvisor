...
the `value` column for Event Deltas directly by modifying the expression above the density heatmap. To analyze this String value we cast it to a UInt64, allowing Event Deltas to analyze response time instead of span duration. ![custom_event_deltas.png](/_next/image?url=%2Fuploads%2Fcustom_event_deltas_3bef4a03e6.png&w=2048&q=75)
...
![custom_event_deltas_columns.png](/_next/image?url=%2Fuploads%2Fcustom_event_deltas_columns_472c53124f.png&w=2048&q=75)
...
![custom_density_event_deltas.png](/_next/image?url=%2Fuploads%2Fcustom_density_event_deltas_3f03425028.png&w=2048&q=75)
