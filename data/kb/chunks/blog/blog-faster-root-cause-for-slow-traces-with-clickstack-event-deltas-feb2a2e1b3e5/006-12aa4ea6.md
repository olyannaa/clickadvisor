...
where latency distributions are expected to be similar \- often a single service. You’ll get clearer, more meaningful results by targeting areas where wide variation is unusual rather than expected. ### Select a clean subset for comparison \#
...
![single_service.png](/_next/image?url=%2Fuploads%2Fsingle_service_1259d4a193.png&w=2048&q=75)
...
![custom_event_deltas.png](/_next/image?url=%2Fuploads%2Fcustom_event_deltas_3bef4a03e6.png&w=2048&q=75)
