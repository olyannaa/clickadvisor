...
of the instructions on the [ClickHouse documentation website](https://clickhouse.com/docs/en/integrations/audit-splunk). ## Audit ClickHouse Cloud from Splunk \# Once configured, the Cloud organization audit logs start flowing into Splunk and are ready for exploration through Splunk search and analytics tools. ![client-only.png](/_next/image?url=%2Fuploads%2Fsplunk_clickhouse_add_on_2_2f18f68739.png&w=2048&q=75)
