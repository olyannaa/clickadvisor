...
(75.02 million rows/s., 1.16 GB/s.) ``` Copy command If we take the quickest runs for each, the query runs about 30% faster in ClickHouse 25\.12\. We can also see that about 30% less data is read from disk.
