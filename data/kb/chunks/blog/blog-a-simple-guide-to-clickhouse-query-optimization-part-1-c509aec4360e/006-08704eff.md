...
2 45FORMAT JSON 46 47--- 481 row in set. Elapsed: 1.414 sec. Processed 329.04 million rows, 8.88 GB (232.63 million rows/s., 6.28 GB/s.) 49Peak memory usage: 451.53 MiB. ``` Copy command Summarize in the table for easy reading.
...
![cloud-query-insight.png](/_next/image?url=%2Fuploads%2Fcloud_query_insight_65ba345736.png&w=2048&q=75)
