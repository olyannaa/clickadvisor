...
means schemas need to be flexible. To capture dynamic user\-specific properties, Trackingplan exploits ClickHouse’s Map and Array types. The aggregation functions for these types allow them to answer even the most complex questions. ## Ever increasing volumes \#
