...
problem: they are usually difficult to implement, require additional fetches from memory, and usually slow down at scale. For example, even a lot of code on the hot path significantly slows down lookups in the hash table. ![](/_next/image?url=%2Fuploads%2FHash_table_simple_chaining_3f8470994c.png&w=2048&q=75)
...
![](/_next/image?url=%2Fuploads%2FHash_table_simple_null_keys_bb6cd14678.png&w=2048&q=75)
