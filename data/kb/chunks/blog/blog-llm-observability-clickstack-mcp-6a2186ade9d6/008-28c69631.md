...
![filter-hyperdx.png](/_next/image?url=%2Fuploads%2Ffilter_hyperdx_bba887537d.png&w=2048&q=75)

Next, let’s filter by the `TraceId`. Click on a log entry, then select Add to Filter next to the TraceId field.

![simple-prompt-filter.gif](/_next/image?url=%2Fuploads%2Fsimple_prompt_filter_a0357864c8.gif&w=2048&q=75)
...
![hyperdx-trace-filter.png](/_next/image?url=%2Fuploads%2Fhyperdx_trace_filter_62010e57cd.png&w=2048&q=75)
