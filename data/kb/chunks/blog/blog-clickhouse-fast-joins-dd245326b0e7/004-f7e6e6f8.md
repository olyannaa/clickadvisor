...
are logically repeated once for every matching order. ``` SELECT o.o_orderkey, o.o_orderdate, c.c_name, c.c_address, c.c_comment FROM orders AS o INNER JOIN customer AS c ON o.o_custkey = c.c_custkey; ``` Copy command Logically, the result looks like this: ![Blog-JOINS-improvements.004.png](/_next/image?url=%2Fuploads%2FBlog_JOINS_improvements_004_3a121d9e14.png&w=2048&q=75)
...
![Blog-JOINS-improvements.005.png](/_next/image?url=%2Fuploads%2FBlog_JOINS_improvements_005_5694c466bf.png&w=2048&q=75)
