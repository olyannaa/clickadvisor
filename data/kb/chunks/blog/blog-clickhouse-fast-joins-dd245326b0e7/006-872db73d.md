...
build one in\-memory hash table. ③ During the probe phase, `orders` rows, the left side of the join, are streamed in parallel and routed to the corresponding hash table for lookup. #### The problem: wasted probe\-side work \#
...
![Blog-JOINS-improvements.007.png](/_next/image?url=%2Fuploads%2FBlog_JOINS_improvements_007_1cf7d0baf0.png&w=2048&q=75)
