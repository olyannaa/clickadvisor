...
In selective joins, this can significantly reduce CPU work and memory bandwidth. #### How it appears in the query plan \# We can see this in the logical query plan with EXPLAIN plan. First, with runtime pre\-filtering disabled:
