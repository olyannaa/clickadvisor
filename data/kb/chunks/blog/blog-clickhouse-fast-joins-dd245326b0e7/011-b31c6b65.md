...
seconds** \- about **1,450× faster** \- while peak memory fell from **99\.1 GiB to 3\.9 GiB**. Taken together, these changes moved joins from “something ClickHouse can do” to something ClickHouse can do **competitively, automatically, and with default settings**.
