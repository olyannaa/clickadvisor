...
more candidate: GPT\-5 \# Just as we were preparing this blog post, OpenAI released GPT\-5\. We couldn’t resist running the experiment with it. It might actually perform best and change how we see LLMs as autonomous observability agents.

Let’s see how it did against the other models. The table below summarizes its performance across the datasets.

![llm-observability-diagram-4.png](/_next/image?url=%2Fuploads%2Fllm_observability_diagram_4_dc47abee65.png&w=2048&q=75)
