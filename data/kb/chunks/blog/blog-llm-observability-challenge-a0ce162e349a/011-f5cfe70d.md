...
see if we can identify any common patterns among the traces using the Event deltas. ![anomaly-2-manual-6.png](/_next/image?url=%2Fuploads%2Fanomaly_2_manual_6_1141a55289.png&w=2048&q=75) On the Event deltas screen, filtered by the get\_product\_list function, we can use the outliers attribute to compare fast and slow requests.
...
![anomaly-2-manual-7.png](/_next/image?url=%2Fuploads%2Fanomaly_2_manual_7_d4ba087db1.png&w=2048&q=75)
