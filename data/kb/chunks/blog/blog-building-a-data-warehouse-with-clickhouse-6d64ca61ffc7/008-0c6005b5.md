...
design \# Given our scale, we need our DWH infrastructure to be simple, easy to operate and easy to scale. After running an internal PoC directly on AWS EC2, we migrated all our infrastructure components to Docker. ![internal_infra_design_v2.png](/_next/image?url=%2Fuploads%2Finternal_infra_design_v2_e508dc1279.png&w=2048&q=75)
