...
with our implementation, reusing the same logic of aggressive retries as for AWS S3\. Results: No more latency spikes! This is enabled by default with the option to use the previous implementation via `azure_sdk_use_native_client=false`. --- Share this post
