...
be omitted. ## CROSS JOIN \# ![cross_join.png](/_next/image?url=%2Fuploads%2Fcross_join_b56f0c751c.png&w=2048&q=75) The CROSS JOIN produces the full cartesian product of the two tables without considering join keys. Each row from the left table is combined with each row from the right table.
