...
│ Ratatouille │ │ """American Dad""" │ └───────────────────────────────────────────┘ 10 rows in set. Elapsed: 0.077 sec. Processed 783.39 thousand rows, 15.42 MB (10.18 million rows/s., 200.47 MB/s.) [✎](https://sql.clickhouse.com?query_id=3R1AT8GC5S4JHPZSGKC6K4) ``` ## (LEFT / RIGHT / INNER) ANY JOIN \# ![any_join.png](/_next/image?url=%2Fuploads%2Fany_join_141ebcdad4.png&w=2048&q=75)
