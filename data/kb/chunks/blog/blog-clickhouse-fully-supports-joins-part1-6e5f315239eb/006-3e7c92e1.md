...
│ └────────────────────────────────────────┴───────────┘ 10 rows in set. Elapsed: 0.150 sec. Processed 783.39 thousand rows, 21.50 MB (5.23 million rows/s., 143.55 MB/s.) [✎](https://sql.clickhouse.com?query_id=ITEJZPXTD1CNGRAZHVBJUY) ``` An alternative syntax for CROSS JOIN specifies multiple tables in the FROM clause separated by commas.
...
![semi_join.png](/_next/image?url=%2Fuploads%2Fsemi_join_abb66358e8.png&w=2048&q=75)
