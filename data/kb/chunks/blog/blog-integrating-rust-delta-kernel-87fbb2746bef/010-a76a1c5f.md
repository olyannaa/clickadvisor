...
compatibility in cross\-compilation scenarios. In the process, we uncovered [a Cargo bug](https://github.com/rust-lang/cargo/issues/15312), now fixed, where specifying \-\-crate\-type\=staticlib multiple times on the command line caused incremental builds to break. #### Random CI failures due to missing sanitizer symbols \#
