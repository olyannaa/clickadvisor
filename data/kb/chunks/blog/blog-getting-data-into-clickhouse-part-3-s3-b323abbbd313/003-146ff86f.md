...
and ask is the spread and is effectively the margin for the broker and how institutions make money. For example, consider the following quote for the EUR/USD pair from 02/09/2022 from [forex.com](https://www.forex.com/en/forex-trading/eur-usd/). ![eur_usd.png](/_next/image?url=%2Fuploads%2Feur_usd_c629e859e3.png&w=2048&q=75) ## Pips and Ticks \#
