...
is the value of CostBench: it turns vendor\-specific runtimes and billing models into a result teams can use when choosing a platform. ## Open and reproducible by design [\#](/blog/costbench-data-warehouse-cost-performance#open-and-reproducible-by-design) CostBench is open because cost\-performance claims should be inspectable.
