...
rows/s., 19.11 MB/s.) 12Peak memory usage: 2.35 MiB. ``` Copy command ## Conclusion \# In this article we have demonstrated how we can use a simple linear regression function to predict output values based on 2 input variables.
