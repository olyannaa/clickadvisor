...
so I can do the detections and surface it to the security analysts." They've also built in extra storage capacity to handle future growth. The result is a real\-time analytics engine that's lightning\-fast, flexible, and ready to scale.
...
![How Exabeam uses ClickHouse for scalable, searchable security analytics 2.png](/_next/image?url=%2Fuploads%2FHow_Exabeam_uses_Click_House_for_scalable_searchable_security_analytics_2_26f8075d52.png&w=2048&q=75)
