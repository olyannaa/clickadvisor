...
new saved dashboard and import the JSON file. To ensure portability, when importing a dashboard you’ll need to map its data sources (logs, traces, or metrics) to those already defined in HyperDX, so all visualizations connect correctly. ![import_dashboard.gif](/_next/image?url=%2Fuploads%2Fimport_dashboard_167dea8e12.gif&w=2048&q=75)
