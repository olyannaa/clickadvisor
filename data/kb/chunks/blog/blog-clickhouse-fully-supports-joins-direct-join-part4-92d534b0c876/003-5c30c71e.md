...
all [query pipeline](https://clickhouse.com/blog/clickhouse-fully-supports-joins-hash-joins-part2#query-pipeline) visualizations, in order to keep them succinct and readable, we artificially limit the level of parallelism used within the ClickHouse query pipeline with the setting `max_threads = 2`. ## Direct Join \# ### Description \#
...
![direct_1.png](/_next/image?url=%2Fuploads%2Fdirect_1_185d6c76d1.png&w=2048&q=75)
