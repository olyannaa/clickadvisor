...
API data allows us to create aggregated views on high cardinality data, generate alerts, and create dashboards based on extensive data. ![ClickHouse_Inigo__3_analytics.png](/_next/image?url=%2Fuploads%2FClick_House_Inigo_3_analytics_7417851102.png&w=2048&q=75) ## Database Alternatives for Large\-Scale Analytics \# Before arriving at ClickHouse, we tried several other databases:
