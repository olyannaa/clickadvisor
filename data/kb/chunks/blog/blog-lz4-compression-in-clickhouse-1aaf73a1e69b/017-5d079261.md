...
```
1Example 1:
2Xeon E2650v2, Browser data, AppVersion column.
3Reference: 1.67 GB/sec.
416 bytes, shuffle: 2.94 GB/sec (76% faster).
5
6Example 2:
7Xeon E2650v2, Direct data, ShowsSumPosition column.
8Reference: 2.30 GB/sec.
916 bytes, shuffle: 1.91 GB/sec (20% slower).
```
Copy command
