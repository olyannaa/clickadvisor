...
) 10} ``` Copy command The GenericChart component uses the [echart](https://echarts.apache.org/examples/en/index.html) for react chart library, but you can easily swap for your preferred ones. You can see the code for the GenericChart component [here](https://github.com/ClickHouse/examples/blob/copilotkit/ai/mcp/copilotkit/components/GenericChart.tsx). ### Final result \#
...
![benefit-db-ai-agents.png](/_next/image?url=%2Fuploads%2Fbenefit_db_ai_agents_c7a5f47245.png&w=2048&q=75)
