...
/// nsw - No Signed Wrap 12 ret i64 %7 13} ``` Copy command We will not use a lot of LLVM IR later in this post, but I highly encourage you to check the LLVM IR documentation.
