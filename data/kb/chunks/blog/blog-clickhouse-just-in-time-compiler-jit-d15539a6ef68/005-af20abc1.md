...
command All interaction between JIT code and code in our main program is typically done this way, we pass pointers to functions in JIT code and call it from JIT code. ## LLVM infrastructure for JIT compilation \#
...
```
1/usr/bin/clang++-12 -S -emit-llvm jit_example.cpp
2
3; Function Attrs: noinline nounwind optnone uwtable mustprogress
4define dso_local i64 @_Z3sumll(i64 %0, i64 %1) #0 {
5  %3 = alloca i64, align 8 /// alloca - allocate memory on stack
6  %4 = alloca i64, align 8
7  store i64 %0, i64* %3, align 8 /// store - store value in pointer
8  store i64 %1, i64* %4, align 8
9  %5 = load i64, i64* %3, align 8 /// load - load value from pointer
10  %6 = load i64, i64* %4, align 8
11  %7 = add nsw i64 %5, %6 /// nsw - No Signed Wrap
12  ret i64 %7
13}
```
Copy command
