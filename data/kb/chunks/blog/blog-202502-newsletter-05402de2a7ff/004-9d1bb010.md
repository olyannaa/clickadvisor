...
also demonstrates how to use ClickHouse alongside Cribl's data processing features, complete with examples using Cribl's Datagen feature to generate test data. ➡️ [Read the blog post](https://cribl.io/blog/clickhouse-and-cribl-a-powerful-data-ingestion-and-analysis-duo/) ## ClickHouse Cloud evolution: compute\-compute separation, improved autoscaling, and more! \#

![5_newsletter202502.png](/_next/image?url=%2Fuploads%2F5_newsletter202502_24dd703b23.png&w=2048&q=75)
