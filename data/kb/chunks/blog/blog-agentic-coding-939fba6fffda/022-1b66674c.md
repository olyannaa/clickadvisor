...
tomorrow. Also, no need to worry much \- today there is overreaction from many sides, but over time it will settle. ### AI makes it easier to write complex code, so the code will be less accessible. \#
