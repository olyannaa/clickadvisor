...
feel achievable. We also chose to describe each step as an outcome rather than a UI action. Instead of telling users to “Open the SQL Console” or “Configure CDC,” we focus on what we want them to accomplish:
...
[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-1688-get-started-today-sign-up&utm_blogctaid=1688)### Get started today
