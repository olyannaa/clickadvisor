...
known. In ClickHouse 25\.12, lazy reading itself became significantly faster. The underlying execution model was redesigned, allowing lazy reading to scale efficiently to **much larger LIMIT values** and unlock additional performance gains. ### Lazy reading before 25\.12 \#
