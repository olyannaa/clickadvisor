...
```
1SELECT table_name, ddl FROM `bigquery-public-data`.crypto_ethereum.INFORMATION_SCHEMA.TABLES
2WHERE  table_name = 'blocks';
```
Copy command
...
6FROM bigquery-public-data.crypto_ethereum.blocks
7
