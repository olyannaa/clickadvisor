...
With this enhancement, new replicas come online before old ones are removed, eliminating capacity gaps during transitions. The result: faster, seamless scaling \- especially important when workloads surge and additional resources are needed in real time. **Single\-replica services**
...
We upgraded the fleet to ARM architecture. We have seen significant performance gains and overall efficiency with the new architecture. Read more about the migration and performance comparisons [here](https://clickhouse.com/blog/graviton-boosts-clickhouse-cloud-performance).
