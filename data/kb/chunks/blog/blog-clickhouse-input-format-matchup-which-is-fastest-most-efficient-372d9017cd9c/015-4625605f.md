...
and clickhouse\-client follows the same principle. The native interface enables advanced techniques to optimize inserts, ensuring efficient transport and minimal server\-side processing. ### HTTP interface \# We illustrate the HTTP interface by using [curl](https://curl.se/) as the client: ![Blog-Formats.011.png](/_next/image?url=%2Fuploads%2FBlog_Formats_011_07446330be.png&w=2048&q=75)
