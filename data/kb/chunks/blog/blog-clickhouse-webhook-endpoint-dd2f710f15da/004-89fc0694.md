...
"user_login", 6 "user_id": 456 7} 8 91 row in set. Elapsed: 0.004 sec. ``` Copy command `webhook_staging` gets a new row, `webhook_logs` doesn't \- the signatures didn't match so the materialized view dropped it. ## GitHub webhook \#
...
```
1https://<host>:8443/?user=webhook_receiver&allow_get_client_http_header=1&query=INSERT+INTO+webhook_staging+(raw_payload)+FORMAT+RawBLOB
```
Copy command
...
![2026-02-20_15-48-01.png](/_next/image?url=%2Fuploads%2F2026_02_20_15_48_01_9837c2f742.png&w=2048&q=75)

GitHub will immediately send a `ping` event. Refresh the webhook page and you should see "Last delivery was successful".

![2026-02-20_15-48-31.png](/_next/image?url=%2Fuploads%2F2026_02_20_15_48_31_e808d6d9c3.png&w=2048&q=75)
...
![2026-02-20_16-11-08.png](/_next/image?url=%2Fuploads%2F2026_02_20_16_11_08_fbcc3df256.png&w=2048&q=75)
