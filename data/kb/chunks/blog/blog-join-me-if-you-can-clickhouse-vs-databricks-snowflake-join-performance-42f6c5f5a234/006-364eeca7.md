...
no config tweaks, no ClickHouse\-specific tricks. Just a clean run of the original benchmark. > In [part 2](https://clickhouse.com/blog/join-me-if-you-can-clickhouse-vs-databricks-snowflake-part-2), we’ll show you how to make it truly fast, the ClickHouse way, with a few powerful tricks up our sleeve.
