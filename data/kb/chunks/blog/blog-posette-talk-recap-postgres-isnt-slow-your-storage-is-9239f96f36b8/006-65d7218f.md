...
which [has discussed local\-NVMe PostgreSQL instances for workloads](https://postgresql.us/events/pgconfus2025/sessions/session/2064/slides/204/) that need them. The recurring pattern is local storage for performance, synchronous replication for availability, and independently stored base backups and WAL archives for recovery. ## The main takeaway \#
