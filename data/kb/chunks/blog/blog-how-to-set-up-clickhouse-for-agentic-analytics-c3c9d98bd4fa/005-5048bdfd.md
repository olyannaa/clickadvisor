...
Copy command ### Create Users \# Now that you have the roles, you can create users for the databases. *Please note that user management for the ClickHouse Cloud console is separate to user management within the database itself.*
