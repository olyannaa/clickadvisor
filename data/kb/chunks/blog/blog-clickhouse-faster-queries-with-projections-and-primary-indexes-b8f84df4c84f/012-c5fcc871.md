...
rows in set. Elapsed: 0.026 sec. Processed 64.00 thousand rows, 5.98 MB (2.46 million rows/s., 230.17 MB/s.) ``` With 20 threads, the query consumes about 40% more peak main memory than the same query run with 4 threads.
