...
into a new part on storage. Go to ①` In ① the portion size depends on the insert block size, which can be controlled with two settings: - [min\_insert\_block\_size\_rows](https://clickhouse.com/docs/en/operations/settings/settings#min-insert-block-size-rows) (default: 1048545 million rows) - [min\_insert\_block\_size\_bytes](https://clickhouse.com/docs/en/operations/settings/settings#min-insert-block-size-bytes) (default: 256 MB)
...
![large_data_loads-p1-04.png](/_next/image?url=%2Fuploads%2Flarge_data_loads_p1_04_00ae369460.png&w=2048&q=75)
