...
### What is Apache Iceberg? \# Originally developed by Netflix, Apache Iceberg is a high\-performance table format that is independent of any specific SQL engine \- allowing it to be queried by any SQL engine, including now ClickHouse!
