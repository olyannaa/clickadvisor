...
of challenges. Solr, being a key\-value store is more suited to search than it is to high\-volume non\-linear aggregation or data compression for performance. Its query language isn’t as mature as SQL and it doesn’t really handle joins.
