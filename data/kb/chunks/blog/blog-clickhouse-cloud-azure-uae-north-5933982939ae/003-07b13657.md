...
eliminates the need for manual sharding or data movement. **Security and Reliability.** Built\-in security best practices including network isolation and traffic encryption. SOC 2 Type II compliant and ISO 27001 certified. Services are automatically replicated across availability zones.
...
Start with a free trial that includes $300 in usage credits to experience the performance of real\-time analytics. 

[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-28-new-to-clickhouse-sign-up&utm_blogctaid=28)
