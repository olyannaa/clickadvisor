...
analytical workloads. Larger text fields, like prompt inputs and model outputs, are deliberately truncated before ingestion. The goal isn’t to capture full transcripts, but to preserve enough context for debugging and analysis without letting row size grow unchecked.
...
[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-329-get-started-today-sign-up&utm_blogctaid=329)## Building fast analytics with materialized views \#
