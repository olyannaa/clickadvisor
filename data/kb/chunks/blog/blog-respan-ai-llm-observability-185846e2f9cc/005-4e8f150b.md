...
that simple." That predictability extends to everyday workflows like log search. Even without relying on advanced full\-text search features, straightforward string queries can scan tens of millions of rows in sub\-second time. As Raymond says, "That’s pretty impressive."
