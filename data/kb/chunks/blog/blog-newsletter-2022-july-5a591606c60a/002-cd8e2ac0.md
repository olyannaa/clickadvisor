...
and there are more talks on using ClickHouse for financial data, optimizing ClickHouse for ARM and visualizing data with ClickHouse. ***When?*** Wednesday, July 20 @ 6 pm BST ***How?*** Register [here](https://www.meetup.com/clickhouse-london-user-group/events/286891586/). - **\[IN PERSON] ClickHouse Silicon Valley Meetup**
