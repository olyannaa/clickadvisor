...
aim to replicate typical usage patterns of a centralized logging solution by an SRE. The full resulting queries can be found [here](https://github.com/ClickHouse/simple-logging-benchmark/tree/main/queries). Below, we evaluate the performance of these queries on varying log volumes. ## Query performance \#
...
![uncompressed_vs_response_time.png](/_next/image?url=%2Fuploads%2Funcompressed_vs_response_time_f4091940d8.png&w=2048&q=75)
...
![response_time_18_gb_logs.png](/_next/image?url=%2Fuploads%2Fresponse_time_18_gb_logs_3151832bc1.png&w=2048&q=75)

At 66 million rows or 19GiB, performance for all queries averages under 0\.1s.

![response_time_75_gb_logs.png](/_next/image?url=%2Fuploads%2Fresponse_time_75_gb_logs_c8b1dd459d.png&w=2048&q=75)
