...
so we can project a more typical retention interval. While this causes the repetition of any inherent data patterns, this is considered sufficient for our tests and akin to typical weekly periodicity seen in logging use cases. ![cyclic_pattern.png](/_next/image?url=%2Fuploads%2Fcyclic_pattern_b64f540176.png&w=2048&q=75)
...
![logs_over_time.png](/_next/image?url=%2Fuploads%2Flogs_over_time_7e0dffed30.png&w=2048&q=75)
...
```
1clickpipes -broker $BOOTSTRAP_URL -username $SASL_USERNAME -password $SASL_PASSWORD -topic $TOPIC -file data-66.csv.gz
2wrote 0 records in 3.5µs, rows/s: 0.000000
3generated schema: [time_local remote_addr remote_user runtime request_type request_path request_protocol status size referer user_agent]
4wrote 10000 records in 63.2115ms, rows/s: 158198.854156
5wrote 20000 records in 1.00043025s, rows/s: 19991.397861
6wrote 30000 records in 2.000464333s, rows/s: 14996.517996
7wrote 40000 records in 3.000462042s, rows/s: 13331.279947
8wrote 50000 records in 4.000462s, rows/s: 12498.556286
```
Copy command
...
[![](/_next/image?url=%2Fuploads%2Fclickpipes_for_logs_11ec2bc51d.gif&w=2048&q=75)](/uploads/clickpipes_for_logs_11ec2bc51d.gif)
