...
existing ClickHouse Cloud users under Monitoring \>\> Query Insights. If you are not yet using ClickHouse Cloud, you can try it today by signing up for a 30\-day trial with $300 free credits [here](https://clickhouse.cloud/signUp). --- Share this post
