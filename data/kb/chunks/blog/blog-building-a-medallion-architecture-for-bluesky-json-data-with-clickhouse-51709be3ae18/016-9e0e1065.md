...
further optimizing this query and reducing the work required. [![](/_next/image?url=%2Fuploads%2FMedallion_with_Bluesky_09_15f7878bcb.png&w=2048&q=75)](/uploads/Medallion_with_Bluesky_09_15f7878bcb.png) This only requires us to identify the partition to flush to the gold tier each time. Our logic here is captured by the diagram above, but in summary:
