...
2AS 3SELECT data.commit.collection AS collection, count() AS posts, 4 uniqState(CAST(data.did, 'String')) AS users 5FROM bluesky 6WHERE kind = 'commit' 7GROUP BY ALL ``` Copy command When querying this table, we use the `-Merge` suffix to merge aggregation states.
...
[![](/_next/image?url=%2Fuploads%2FMedallion_with_Bluesky_11_009af5408a.png&w=2048&q=75)](/uploads/Medallion_with_Bluesky_11_009af5408a.png)
...
[![](/_next/image?url=%2Fuploads%2FMedallion_with_Bluesky_12_e76f620200.png&w=2048&q=75)](/uploads/Medallion_with_Bluesky_12_e76f620200.png)
