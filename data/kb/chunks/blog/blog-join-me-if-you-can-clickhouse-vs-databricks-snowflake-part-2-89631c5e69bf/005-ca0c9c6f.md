...
on time. These small changes remove full joins from the query plan, replacing them with ultra\-fast lookups in memory. The pattern is repeatable and easy to apply across [all](https://github.com/sdairs/coffeeshop-benchmark/blob/main/clickhouse-cloud-tuned/queries.sql) 17 benchmark queries. ## Results: How much faster? \#
...
![image.png](/_next/image?url=%2Fuploads%2Fimage_388111140b.png&w=2048&q=75)
...
![perf_excl_q10_q16_1b.png](/_next/image?url=%2Fuploads%2Fperf_excl_q10_q16_1b_9eddc4e8af.png&w=2048&q=75)
