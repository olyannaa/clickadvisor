...
we do not increase or decrease the number of replicas. Instead, we do a rolling restart 1\-replica at a time. Upon restarting, the server pods come up with the new size. > The CPU:Memory shape is currently preserved.
...
![pod_scaling.png](/_next/image?url=%2Fuploads%2Fpod_scaling_59ddb8e08c.png&w=2048&q=75)
