...
cluster. Indeed, in the worst case scenarios, the remaining replicas can crumble under the pressure and might also get OOM\-killed or the CPU might get throttled. ## Make Before Break \# ### And the limitations of StatefulSets \#
...
![limitations_stateful_sets.png](/_next/image?url=%2Fuploads%2Flimitations_stateful_sets_d00ef2e1fb.png&w=2048&q=75)
...
![ordinals.png](/_next/image?url=%2Fuploads%2Fordinals_361d9e45f1.png&w=2048&q=75)
