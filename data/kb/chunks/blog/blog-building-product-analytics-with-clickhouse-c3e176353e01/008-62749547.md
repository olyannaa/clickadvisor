...
both a subset of columns and rows, using a primary key and secondary indices optimized for use in subsequent queries. ![Blog_ProductAnalytics_202411_V1.0-01.png](/_next/image?url=%2Fuploads%2FBlog_Product_Analytics_202411_V1_0_01_d4703bc148.png&w=2048&q=75) As a simple example of this, the `prod_pageviews_mv` captures a subset of columns for page view events:
...
```
1import { useGalaxyOnPage } from '../lib/galaxy/galaxy'
