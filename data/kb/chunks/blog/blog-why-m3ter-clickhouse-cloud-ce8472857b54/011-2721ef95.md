...
## Scaling \# Many of the services tested offer automatic scaling based on workload. This was attractive to us, since we don’t want to spend our engineers' time monitoring the performance and scaling services up and down regularly.
