...
(and copies hot data to fast local disks), have the additional benefit that S3 itself offers high reliability and redundancy out of the box, so the probability of encountering a DR scenario is reduced. ## Overall Cost \#
