...
test this plugin rigorously against ClickHouse Cloud and ensure the [current dbt plugin test](https://docs.getdbt.com/guides/dbt-ecosystem/adapter-development/4-testing-a-new-adapter) suite passes. ## How is it useful to ClickHouse users? \# We primarily see users using dbt with ClickHouse for a number of tasks:
