...
### Query routing \# Although the above addressed a number of challenges, it introduced a new layer of complexity around how we assign queries from a user to a specific cluster. Let's take an example to illustrate it:
...
![Query routing 1.png](/_next/image?url=%2Fuploads%2FQuery_routing_1_8eec2445cf.png&w=2048&q=75)
...
![Query routing 2.png](/_next/image?url=%2Fuploads%2FQuery_routing_2_b66bf6d20f.png&w=2048&q=75)
