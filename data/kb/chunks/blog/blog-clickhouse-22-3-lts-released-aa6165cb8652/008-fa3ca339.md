...
cache for remote filesystem, implemented by **Ksenia Sumarokova**. This feature is available for preview. It gives [tremendous improvements in performance](https://youtu.be/GzeANZzPras?t=389). The cache is hybrid — it is using both the local disks and RAM. ## **What Else?** \#
