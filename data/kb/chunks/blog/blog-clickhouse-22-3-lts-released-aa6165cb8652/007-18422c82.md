...
│ Other │ 38│ 20 │ apache/incubator-mxnet │ 19938 │ Apache License 2.0 │ 39└────┴───────────────────────────────────────┴───────────────────────┴─────────────────────────────────────────┘ ``` Copy command So, ClickHouse is the 17th most popular C\+\+ repository on GitHub. Not bad. Let me explain how dynamic subcolumns work:
...
```
1SELECT * FROM table
2WHERE key IN (111, 222, ... a megabyte of something)
```
Copy command
