...
or server failures. We can enable the new engine by using these settings: ``` 1CREATE TABLE ... ENGINE = Kafka( 2 'localhost:19092', 'topic', 'consumer', 'JSONEachRow') 3SETTINGS 4 kafka_keeper_path = '/clickhouse/{database}/kafka', 5 kafka_replica_name = 'r1'; ``` Copy command ---
