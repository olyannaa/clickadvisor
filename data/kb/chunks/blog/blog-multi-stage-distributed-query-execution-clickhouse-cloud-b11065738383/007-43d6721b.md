...
**Step 5: Sort locally and gather the final result** \# Each worker sorts its aggregated results by revenue. The GatherExchange (line 3\) combines the sorted results from all workers at the coordinator to produce the final output. ![Blog-Distributed_JOINS-introduction.015.png](/_next/image?url=%2Fuploads%2FBlog_Distributed_JOINS_introduction_015_227587d6be.png&w=2048&q=75)
