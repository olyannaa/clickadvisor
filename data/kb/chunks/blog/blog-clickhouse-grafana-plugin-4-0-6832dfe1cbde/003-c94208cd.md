...
full trace profile, can be abstracted. These queries assume data is structured similarly to OTel, so users deviating significantly from the standard schema will need to use views to benefit from this feature. ## A simpler experience \#
...
![version3_grafana_plugin.png](/_next/image?url=%2Fuploads%2Fversion3_grafana_plugin_7a4282e198.png&w=2048&q=75)
*version 3*
...
![version4_grafana_plugin.png](/_next/image?url=%2Fuploads%2Fversion4_grafana_plugin_3f438d44ef.png&w=2048&q=75)
*version 4*
