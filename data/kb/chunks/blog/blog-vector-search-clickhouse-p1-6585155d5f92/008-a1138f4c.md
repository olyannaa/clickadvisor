...
many applications. ANN algorithms are beneficial in applications where the dataset is large, and the search needs to be performed quickly. Examples here include Hierarchical Navigable Small World (HNSW) and Annoy algorithms. ![annoy.png](/_next/image?url=%2Fuploads%2Fannoy_cd47ba916f.png&w=2048&q=75) Annoy algorithm Credit: [Alexey Milovidov](https://twitter.com/ClickHouseDB/status/1650873994944434179)
