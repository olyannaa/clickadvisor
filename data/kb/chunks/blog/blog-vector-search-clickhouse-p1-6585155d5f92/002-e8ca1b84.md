...
can be done in ClickHouse, you can find Part II [here](https://clickhouse.com/blog/vector-search-clickhouse-p2). ### Search before vectors \# Let’s briefly cover how search worked with traditional engines like Elasticsearch and Solr (note: these technologies now also offer vector search capabilities).
...
![bag_of_words_inverted_index.png](/_next/image?url=%2Fuploads%2Fbag_of_words_inverted_index_d5a8b20440.png&w=2048&q=75)
...
![tf_idf.png](/_next/image?url=%2Fuploads%2Ftf_idf_5e8bd922ac.png&w=2048&q=75)
