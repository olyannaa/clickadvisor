...
the Amazon reviews dataset illustrates this clearly: Parquet and ORC loaded in **79 seconds**, Avro in **94 seconds**, and JSON in **105 seconds**. ![](/_next/image?url=%2Fuploads%2FClick_House_Blog_Banner_Tips_5_f05b99b445.jpg&w=2048&q=75) For managed, ongoing ingestion from object storage, ClickPipes supports S3 and GCS sources directly.
...
## 7\. Compute on write, faster reads with materialized views and projections \#
