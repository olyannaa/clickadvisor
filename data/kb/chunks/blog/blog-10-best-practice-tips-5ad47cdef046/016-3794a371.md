...
With partitioning by month or year, each partition stays within a manageable size range where merging down to a single part is achievable, which is exactly the state where `FINAL` performs best. ## 10\. Optimize your joins \#
...
![ClickHouse Blog Banner Tips-6.jpg](/_next/image?url=%2Fuploads%2FClick_House_Blog_Banner_Tips_6_6243a66bcb.jpg&w=2048&q=75)
