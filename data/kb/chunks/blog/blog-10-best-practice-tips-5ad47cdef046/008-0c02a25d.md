...
the payload remains fully dynamic. When converting Amazon Reviews dataset to a document based dataset, using hints reduced storage by 38% vs JSON without hints and this example query was 26% faster when using hints vs. without ones.
...
## 6\. Getting data into ClickHouse the right way \#
...
![](/_next/image?url=%2Fuploads%2FClick_House_Blog_Banner_Tips_5_f05b99b445.jpg&w=2048&q=75)
