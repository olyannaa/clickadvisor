...
in Parquet format in a remote object storage bucket for archival purposes using the S3 table functions, effectively expanding your retention capabilities e.g. for compliance adherence, while still being able to [query data remotely](https://www.youtube.com/watch?v=nnvtLLFy8fc). ##### Unparalleled Expressivity \#
...
![img06.png](/_next/image?url=%2Fuploads%2Fimg06_48f35a2b21.png&w=2048&q=75)
