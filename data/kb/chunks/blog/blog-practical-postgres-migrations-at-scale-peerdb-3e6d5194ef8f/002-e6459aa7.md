...
Postgres to Postgres migration capability is designed to address these constraints directly. It offers **high\-speed initial load** and continuous CDC while **supporting TOAST columns without requiring REPLICA IDENTITY FULL**, automatic **column additions,** and PeerDB is **fully open source**.
