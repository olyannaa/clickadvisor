...
the 100 million rows of the dataset into: - 100 files, each with 1 million rows - 6 file versions: all combinations of with/without [pre\-sorting](https://github.com/ClickHouse/examples/blob/2f9f05f7b04a1da6269b6d2c41499a9fa336c25c/blog-examples/FastFormatReads/main.sh#L46) and with/without [compression](https://github.com/ClickHouse/examples/blob/2f9f05f7b04a1da6269b6d2c41499a9fa336c25c/blog-examples/FastFormatReads/main.sh#L48) (LZ4, ZSTD) ### Running the queries: ClickBench for files \#
