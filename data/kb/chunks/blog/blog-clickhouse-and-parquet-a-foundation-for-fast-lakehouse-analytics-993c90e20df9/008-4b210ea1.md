...
in parallel using four threads. #### Example 2: Two Parquet files, 4 cores \# In the second example, we keep `max_threads` and `max_parsing_threads` set to 4 but change the file path pattern to match exactly 2 Parquet files:
...
```
Copy command
![Blog-FormatsReads.008.png](/_next/image?url=%2Fuploads%2FBlog_Formats_Reads_008_b0a439b7b2.png&w=2048&q=75)
...
```
Copy command
![Blog-FormatsReads.009.png](/_next/image?url=%2Fuploads%2FBlog_Formats_Reads_009_9af83ce703.png&w=2048&q=75)
...
![Blog-FormatsReads.010.png](/_next/image?url=%2Fuploads%2FBlog_Formats_Reads_010_49b4ff82b5.png&w=2048&q=75)
