...
in reality, they are not, with clusters of vectors being more common. If planes divide these clusters, then the proximity of two neighboring vectors can effectively be lost in the encoding. For example, consider the diagram below: ![splitting_clusters_ann.png](/_next/image?url=%2Fuploads%2Fsplitting_clusters_ann_88bdb9b548.png&w=2048&q=75)
