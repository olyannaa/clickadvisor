...
manage version\-controlled configurations by using [AWS Cloud Formation](https://docs.aws.amazon.com/glue/latest/dg/populate-with-cloudformation-templates.html) to define ETL objects like scripts or triggers. Below is an example of creating a cron job for an AWS Glue job that runs every 10 minutes Monday to Friday.
...
![12_awsglue.png](/_next/image?url=%2Fuploads%2F12_awsglue_a6298e4eeb.png&w=2048&q=75)
