...
from ClickHouse into a Spark Dataframe #### Full scripts for the example Glue job \# Copy and paste the whole script into your AWS Glue job. Remember to configure the connector, your environment, and variables as shown above!
