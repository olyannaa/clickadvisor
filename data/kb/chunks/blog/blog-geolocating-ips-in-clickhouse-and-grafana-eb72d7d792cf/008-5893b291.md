...
coords 23group by 24 hash ``` Copy command ![dictGeoHash.png](/_next/image?url=%2Fuploads%2Fdict_Geo_Hash_02a40f61e0.png&w=2048&q=75) Using geo\-hashing, we've now rolled up 20M\+ records into \~6300 results. Loading this query into Grafana to power a `Geo Map` chart panel will produce a rich visualization: ![grafana_geo_hash.png](/_next/image?url=%2Fuploads%2Fgrafana_geo_hash_7d8ef9e91b.png&w=2048&q=75)
