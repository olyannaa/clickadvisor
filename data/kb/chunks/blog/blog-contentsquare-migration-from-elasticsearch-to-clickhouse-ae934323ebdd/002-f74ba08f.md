...
choices in order to lift this technical limitation and support the growth of the company: 1. Figure out a way to host each tenant efficiently in a multi\-cluster setup. 2. Migrate to a more scalable piece of technology.
...
![contensquare_timeline.png](/_next/image?url=%2Fuploads%2Fcontensquare_timeline_0aa78d02fd.png&w=2048&q=75)
