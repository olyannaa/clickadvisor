...
we run a highly reliable and highly custom collector architecture that has absorbed many database outages without losing data. Because we removed our PVCs for the local WALs, our stack has become operationally lighter and significantly more cost\-effective.
...
[Sign up](https://console.clickhouse.cloud/signUp?intent=o11y&loc=blog-cta-1644-get-started-today-sign-up&utm_blogctaid=1644)### Get started today
