...
an LTS release). ## **Query of the Month: Materialized, but still real\-time** \# ClickHouse is often used to store high frequency time series data. For example, financial tick data (prices of stocks, bonds, crypto, etc.) or sensor data.
