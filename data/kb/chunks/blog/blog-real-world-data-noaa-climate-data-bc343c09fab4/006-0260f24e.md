...
analysis: id, latitude, longitude, elevation, and name. To parse this file, we use the [Regexp](https://clickhouse.com/docs/en/interfaces/formats/#data-format-regexp) Format with a simple regex group capturing each column. We join this to our newly created noaa.tsv. ``` wget http://noaa-ghcn-pds.s3.amazonaws.com/ghcnd-stations.txt ``` Copy command
