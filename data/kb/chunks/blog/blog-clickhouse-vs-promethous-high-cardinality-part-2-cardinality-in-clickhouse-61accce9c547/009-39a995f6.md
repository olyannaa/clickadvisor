...
```
Copy commandThe following shows the cardinality of each column, as well as the total cardinality if we were to represent this using a time series model.
