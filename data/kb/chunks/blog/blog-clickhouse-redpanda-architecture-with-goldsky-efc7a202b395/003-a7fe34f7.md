...
presented a challenge from a data engineering perspective \- how to efficiently stream the same TiB datasets to potentially 10s of thousands of ClickHouse instances while providing customer\-independent processing that may target only subsets. ## Architecture \# ![gold_sky_architecture.png](/_next/image?url=%2Fuploads%2Fgold_sky_architecture_8455529196.png&w=2048&q=75)
