...
8UInt64 UserID = hash(4, powerLaw(5000, 1.1)); 9UserID = UserID / 10000000000ULL * 10000000000ULL 10 + static_cast<time_t>(EventTime) + UserID % 1000000; 11 12random_with_seed.seed(powerLaw(5000, 1.1)); 13auto get_random_with_seed = [&]{ return random_with_seed(); }; ``` Copy command Advantages: - Conceptual simplicity. Disadvantages:
