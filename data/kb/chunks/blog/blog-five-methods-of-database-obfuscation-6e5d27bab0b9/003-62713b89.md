...
this SQL query: ``` 1SELECT RegionID, uniq(UserID) AS visitors 2 FROM test.hits 3GROUP BY RegionID 4ORDER BY visitors DESC 5LIMIT 10 ``` Copy command This was a typical query for web analytics product. What affects the processing speed?
