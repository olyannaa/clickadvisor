...
network is iterative, consisting of rounds. Each round is a remarkable transformation that allows you to get a one\-to\-one function from any function. Let's look at how it works. 1. The argument's bits are divided into two halves:
