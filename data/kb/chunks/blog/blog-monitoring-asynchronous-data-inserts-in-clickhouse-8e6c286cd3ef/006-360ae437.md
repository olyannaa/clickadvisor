...
part being written to disk every 30 seconds per node. See the highlighted rows in the two query results above, where the same color is used for corresponding buffer flushes and part creations. ### Multiple partitioning keys \#
...
![monitoring_async_inserts_09.png](/_next/image?url=%2Fuploads%2Fmonitoring_async_inserts_09_de264230e3.png&w=2048&q=75)
...
![monitoring_async_inserts_10.png](/_next/image?url=%2Fuploads%2Fmonitoring_async_inserts_10_3171ae2deb.png&w=2048&q=75)
