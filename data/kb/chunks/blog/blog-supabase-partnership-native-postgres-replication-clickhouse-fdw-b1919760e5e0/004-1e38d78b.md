...
replicate data using the IPv6 addresses that Supabase provides by default. We plan to extend IPv6 support to the Postgres CDC connector in ClickPipes once PeerDB is fully integrated in ClickPipes. ## clickhouse\_fdw: Query ClickHouse from Supabase \#

![Supabase ClickHouse Reference Archiecture.png](/_next/image?url=%2Fuploads%2FSupabase_Click_House_Reference_Archiecture_0213636772.png&w=2048&q=75)
