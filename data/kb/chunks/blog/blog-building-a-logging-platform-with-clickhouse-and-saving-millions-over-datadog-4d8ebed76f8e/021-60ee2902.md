...
data source. When a user queries for a specific namespace or pod, the custom plugin we built ensures only the data source associated with the pod's region is queried. ## Performance and cost \# ### Cost analysis \#
...
![logging_10.png](/_next/image?url=%2Fuploads%2Flogging_10_f756246996.png&w=2048&q=75)

![logging_11.png](/_next/image?url=%2Fuploads%2Flogging_11_5de2b0777f.png&w=2048&q=75)
