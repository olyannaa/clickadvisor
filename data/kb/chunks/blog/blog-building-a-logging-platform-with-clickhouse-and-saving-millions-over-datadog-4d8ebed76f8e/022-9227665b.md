...
per month throughput (uncompressed) **`Cost ($) = EC2 Cost (Ingest/Query) + Retention (S3) = (22.55 * T) + ((T*1024 )/17 * 0.021) = 23.76T`** **This gives us a cost per TiB (uncompressed) per month of $23\.76\.** ![logging_10.png](/_next/image?url=%2Fuploads%2Flogging_10_f756246996.png&w=2048&q=75) ![logging_11.png](/_next/image?url=%2Fuploads%2Flogging_11_5de2b0777f.png&w=2048&q=75)
