...
stack includes an out\-of\-the\-box OpenTelemetry collector, a UI designed for wide events, natural language querying, session replay, alerting, and more. And it all runs on the same high\-performance, high\-compression ClickHouse engine trusted by the biggest names in observability.
...
![clickstack_timeline.png](/_next/image?url=%2Fuploads%2Fclickstack_timeline_c2f60d65eb.png&w=2048&q=75)
