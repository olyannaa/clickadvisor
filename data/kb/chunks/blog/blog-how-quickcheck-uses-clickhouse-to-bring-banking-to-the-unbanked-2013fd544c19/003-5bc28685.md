...
are: - Aggregation functions (AVG, SUM, etc) across 100s of millions of rows to create dashboards - Window and statistical and functions - Column compression to save on disk space usage ## **Advice to other ClickHouse users** \#
