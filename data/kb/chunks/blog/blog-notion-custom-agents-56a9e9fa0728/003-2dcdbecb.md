...
write the summary to a Notion page. The agent runs the queries against ClickStack, formats the numbers, and updates the page before your team logs on. No dashboard to open and no query to rerun. ![Notion Image 4.png](/_next/image?url=%2Fuploads%2FNotion_Image_4_a258ef6c83.png&w=2048&q=75)
