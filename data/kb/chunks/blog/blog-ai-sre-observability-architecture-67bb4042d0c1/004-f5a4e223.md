...
can't learn from the organization's own history, and no amount of prompt engineering fixes missing data. > If your logs can’t remember more than two weeks, neither can your AI SRE. ### Problem 2: [The cardinality problem](https://clickhouse.com/resources/engineering/high-cardinality-slow-observability-challenge) \#
