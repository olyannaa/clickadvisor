...
```
1select count(*) as count,assetContainerID from findings where status='open' group by assetContainerID
```
Copy command
![Dasana_Query.png](/_next/image?url=%2Fuploads%2FDasana_Query_5637ad20fe.png&w=2048&q=75)
