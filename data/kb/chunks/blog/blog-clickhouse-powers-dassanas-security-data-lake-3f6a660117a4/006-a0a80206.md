...
but it is sometimes tempting to use experimental features. For example, we started using projections when they were almost in production, but we should have waited. Wait for the training wheels to come off. ### About Dassana [\#](/blog/clickhouse-powers-dassanas-security-data-lake#about-dassana)
