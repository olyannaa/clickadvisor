...
terraform destroy -no-color -auto-approve 66 env: 67 TF_VAR_organization_id: ${{ secrets.INTEGRATIONS_TEAM_TESTS_ORGANIZATION_ID }} 68 TF_VAR_token_key: ${{ secrets.INTEGRATIONS_TEAM_TESTS_TOKEN_KEY }} 69 TF_VAR_token_secret: ${{ secrets.INTEGRATIONS_TEAM_TESTS_TOKEN_SECRET }} 70 TF_VAR_service_password: ${{ secrets.INTEGRATIONS_TEAM_TESTS_CLOUD_PASSWORD }} ``` Copy command In summary, this workflow consists of the following steps:
...
![git_actions.png](/_next/image?url=%2Fuploads%2Fgit_actions_a428225503.png&w=2048&q=75)
