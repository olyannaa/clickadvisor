...
blog and requires further testing. The associated JSON configuration for the above can be found [here](https://github.com/ClickHouse/examples/tree/main/blog-examples/postgresql-cdc/connectors) and can be used with the officially documented [steps](https://docs.confluent.io/cloud/current/connectors/cc-postgresql-cdc-source-debezium.html). Self\-managed installation instructions can be found [here](https://debezium.io/documentation/reference/stable/connectors/postgresql.html#postgresql-deployment). ### Configure Kafka Connect sink \#
...
![kafka_connect_config.gif](/_next/image?url=%2Fuploads%2Fkafka_connect_config_e59fefc4c4.gif&w=2048&q=75)
