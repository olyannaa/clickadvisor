...
interactive use cases, like the above\-mentioned [ClickPy application](https://clickpy.clickhouse.com/). Both Elasticsearch and ClickHouse provide built\-in techniques for automatic continuous data summarization. Their techniques have the same functional capabilities but drastically differ in implementation, efficiency, and with that, computing costs.
