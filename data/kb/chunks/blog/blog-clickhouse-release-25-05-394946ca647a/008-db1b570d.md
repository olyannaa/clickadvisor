...
and the official history of FIFA describes the competition as having been a failure. 22url: https://en.wikipedia.org/wiki?curid=11370 23dist: 7.5603456 24dist: 7.736428 ``` Copy command As mentioned earlier, the `WHERE` clause can be evaluated using a [post\-filtering or pre\-filtering strategy.](https://clickhouse.com/docs/engines/table-engines/mergetree-family/annindexes#using-a-vector-similarity-index)
