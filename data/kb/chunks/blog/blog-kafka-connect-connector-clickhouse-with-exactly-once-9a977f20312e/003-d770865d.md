...
in order to be able to restore ingestion from partial states. ### The ClickHouse \- Kafka Landscape \# ClickHouse has supported a [number of techniques](https://clickhouse.com/docs/en/integrations/kafka#choosing-an-approach) to achieve ingestion from Kafka, each with its own respective pros and cons.
