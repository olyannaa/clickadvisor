...
```
1curl https://raw.githubusercontent.com/fluent/fluent-bit/master/install.sh | sh
```
Copy command
...
```
1sudo wget -O /var/log/access.log https://gist.githubusercontent.com/agup006/b936d299c11b60283bdaf05a12e334eb/raw/b87905c7ea1e21745dba87233666135ee61d0087/apache-access.log
2sudo chmod a+r /var/log/access.log
```
Copy command
