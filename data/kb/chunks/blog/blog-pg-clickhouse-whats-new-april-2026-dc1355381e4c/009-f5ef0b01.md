...
of brute force memory measurement produces inaccurate results, generally showing Postgres using far more memory that it does, in absolute terms. We deem it acceptable here, however, for a relative comparison. [↩](#user-content-fnref-pg-mem) ### Try Postgres managed by ClickHouse
...
[Get access](https://clickhouse.com/cloud/postgres?loc=blog-cta-1558-try-postgres-managed-by-clickhouse-get-access&utm_blogctaid=1558)
