...
a given subject Given OpenAI’s recent popularity and high\-profile ChatGPT offering, we use OpenAI as an example. However, the simplicity of this approach means it can be easily adapted to competing services. ## User Defined Functions (UDFs) \#
...
![open_ai_udfs.png](/_next/image?url=%2Fuploads%2Fopen_ai_udfs_53eefe62df.png&w=2048&q=75)
