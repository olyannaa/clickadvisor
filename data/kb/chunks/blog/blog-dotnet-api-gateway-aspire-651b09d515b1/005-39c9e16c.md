...
Layer \# The core middleware pattern is straightforward: - Start a stopwatch - Call the next delegate - Normalize the route - Capture the current trace id - Emit gateway metrics - Enqueue a row for background ingestion
