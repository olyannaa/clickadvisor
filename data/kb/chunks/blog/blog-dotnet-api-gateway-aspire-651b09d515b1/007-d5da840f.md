...
16PARTITION BY toYYYYMMDD(timestamp) 17ORDER BY (upstream_service, route_pattern, timestamp) 18TTL timestamp + INTERVAL 30 DAY; ``` Copy command A few of the type choices are worth calling out because they have no direct equivalent in SQL Server or Postgres:
