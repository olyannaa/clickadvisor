...
By leveraging ClickHouse’s [SummingMergeTree](/docs/en/engines/table-engines/mergetree-family/summingmergetree) engine, GENIEE has fully automated the aggregation of metrics like impressions and costs. This allows GENIEE to avoid the manual processing and recounting that plagued their old system. ### Dictionaries and metadata handling \#
