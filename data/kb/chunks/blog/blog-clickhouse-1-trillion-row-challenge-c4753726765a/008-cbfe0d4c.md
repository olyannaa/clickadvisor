...
command > The above uses `FORMAT Null` so that results are not printed, and we can easily identify the actual query time. As the response is small, we consider this overhead negligible compared to the full query processing.
...
[![](/_next/image?url=%2Fuploads%2Fsingle_node_1trillion_6f85c1b0da.png&w=2048&q=75)](/uploads/single_node_1trillion_6f85c1b0da.png)
...
[![](/_next/image?url=%2Fuploads%2Fsingle_node_1trillion_larger_buffer_bdeea413dc.png&w=2048&q=75)](/uploads/single_node_1trillion_larger_buffer_bdeea413dc.png)
