...
template\-based - Streaming ACID transactions across multiple tables - Single Record Transformations - Multi Record Transformations (splits, joins, aggregations) - Exactly\-once Hopefully, this connector will enable you to enjoy the benefits of ClickHouse more easily, as we do.
