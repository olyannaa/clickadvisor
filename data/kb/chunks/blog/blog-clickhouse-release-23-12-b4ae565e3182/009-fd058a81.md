...
```
1CREATE TABLE uk_property_offers
2(
3    postcode1 LowCardinality(String),
4    postcode2 LowCardinality(String),
...
9    …
10)
11ENGINE = ReplacingMergeTree
12ORDER BY (postcode1, postcode2, street, addr1, addr2);
```
Copy command
