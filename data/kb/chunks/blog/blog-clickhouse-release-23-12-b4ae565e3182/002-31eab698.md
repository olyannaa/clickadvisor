...
here, please reach out to us...but we will be finding you on twitter, etc as well. You can also view the [slides from the presentation](https://presentations.clickhouse.com/release_23.12). ## Refreshable Materialized Views \# ### Contributed by Michael Kolupaev, Michael Guzov \#
