...
exploration and preparation \# ### Data exploration \# After defining the machine learning problem, goals, and success criteria \- a common next step is to explore the relevant data that will be used for model training and evaluation.
