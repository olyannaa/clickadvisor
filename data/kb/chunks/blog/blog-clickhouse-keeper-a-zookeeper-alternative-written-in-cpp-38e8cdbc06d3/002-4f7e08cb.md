...
and reliable [information repository](https://en.wikipedia.org/wiki/Information_repository) and [consensus](https://en.wikipedia.org/wiki/Consensus_(computer_science)) system for coordinating and synchronizing distributed operations. For ClickHouse, [ZooKeeper](https://zookeeper.apache.org/) was initially chosen for this. It was reliable through its wide usage, provided a simple and powerful API, and offered reasonable performance.
