...
③. We present runtimes for all runs above in the next chart. We can see in the tabular result that (major) garbage collection takes place a few times during the ZooKeeper runs. #### Runtime and CPU usage \#
...
![Keeper-06.png](/_next/image?url=%2Fuploads%2FKeeper_06_04cf699a40.png&w=2048&q=75)
...
![Keeper-08.png](/_next/image?url=%2Fuploads%2FKeeper_08_3b3e4bbd75.png&w=2048&q=75)
