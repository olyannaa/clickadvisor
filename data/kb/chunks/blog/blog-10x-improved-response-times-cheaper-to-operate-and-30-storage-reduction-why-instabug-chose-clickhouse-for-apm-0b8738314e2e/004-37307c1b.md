...
we have to go through for recent date filters ranges, etc. which made Elasticsearch continue for a little longer… but we realized that it would not scale and we needed to find another solution. ## **Enter ClickHouse** \#
...
![arch.png](/_next/image?url=%2Fuploads%2Farch_cb189f2848.png&w=2048&q=75)
