...
lot of aggregate functions which also helped us write new features into ClickHouse. ## **Lessons learned and challenges** \# While migrating to ClickHouse we faced some challenges that we had to work around. Some of those challenges were:
