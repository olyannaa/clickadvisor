...
allow us to run multiple clusters and even host different event metric data into different databases or clusters as per our needs. ## **Current architecture using ClickHouse** \# The following diagram shows the overall architecture of APM: ![arch.png](/_next/image?url=%2Fuploads%2Farch_cb189f2848.png&w=2048&q=75)
