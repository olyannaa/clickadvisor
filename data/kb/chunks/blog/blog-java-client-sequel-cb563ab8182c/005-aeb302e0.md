...
col3 FROM " + DATASET_TABLE 3 ).get(3, TimeUnit.SECONDS); 4 System.out.println("Result rows: " + records.getResultRows()); 5 6 7 for (GenericRecord record : records) { 8 record.getString(3); // string column col3 9 } ``` Copy command ## Next Steps \#
