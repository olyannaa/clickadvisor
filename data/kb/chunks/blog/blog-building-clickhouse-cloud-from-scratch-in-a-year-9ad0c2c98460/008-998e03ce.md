...
is where the credentials are persisted. When you spin up a new ClickHouse service, we ask you to download credentials during onboarding, and do not store it beyond the session. ## Scalability and Reliability \# ### Scalability \#
...
![We are able to do away with some of the components required in Knative because our proxy is tightly integrated with our Kubernetes operators.](/_next/image?url=%2Fuploads%2Fmetrics_store_818c1c61c8.png&w=2048&q=75)
