...
same time, we made sure we had a direct Slack channel available for each private preview user, so we could hear the voice of the customer directly and address any concerns efficiently. ## Architecture of ClickHouse Cloud \#
...
![Architecture of ClickHouse Cloud](/_next/image?url=%2Fuploads%2Fclickhouse_cloud_account_8c8d4f27e7.png&w=2048&q=75)
