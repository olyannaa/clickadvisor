...
cluster using a free trial, load the data, let us deal with the infrastructure, and get querying! ## A quick recap \# For those of you new to the weather dataset, our original table schema looked like this:
