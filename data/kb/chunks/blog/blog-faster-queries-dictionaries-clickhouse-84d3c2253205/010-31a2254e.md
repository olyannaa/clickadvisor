...
JOIN clauses like tables (see below). This suffers from the same challenge as the previous proposal, delivering comparable performance. We of course welcome improvements! ### Something more complex \# Consider the final query in our original blog post:
