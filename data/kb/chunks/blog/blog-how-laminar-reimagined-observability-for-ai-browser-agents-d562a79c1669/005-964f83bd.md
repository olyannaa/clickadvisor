...
and ingest 100s of GB of data daily (millions of traces) due to ClickHouse scalability and their extremely fast Rust backend. Can ClickHouse Cloud transform your data operations? [Try it free for 30 days.](https://clickhouse.com/cloud) --- Share this post
