...
due to them being saved before the number of buckets was increased. In this case, we save them to the new actual buckets and process them further. This process is repeated for all of the remaining buckets. ![grace-final-step.png](/_next/image?url=%2Fuploads%2Fgrace_final_step_8424107c1a.png&w=2048&q=75)
...
![url-self-join.png](/_next/image?url=%2Fuploads%2Furl_self_join_511e5fc0c9.png&w=2048&q=75)
...
![hash-algorithms.png](/_next/image?url=%2Fuploads%2Fhash_algorithms_061cca0703.png&w=2048&q=75)
![hash-join-results.png](/_next/image?url=%2Fuploads%2Fhash_join_results_ee7184297b.png&w=2048&q=75)
