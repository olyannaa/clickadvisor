...
A table with multiple text or vector indexes can easily accumulate hundreds of gigabytes of index data that previously had to be replicated across every node. ## What happens when a replica is added to the service? \#
...
![Blog-Index_Sharding.009.png](/_next/image?url=%2Fuploads%2FBlog_Index_Sharding_009_3f8d705b6b.png&w=2048&q=75)
