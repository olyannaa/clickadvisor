...
To try it, install the Hud SDK and connect it to your ClickStack account. Runtime intelligence starts flowing alongside the OpenTelemetry data you already collect. You can [read the docs](https://docs.hud.io/docs/clickhouse-clickstack-integration) to get set up. ### Try it today
