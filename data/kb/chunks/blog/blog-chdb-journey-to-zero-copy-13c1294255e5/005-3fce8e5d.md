...
--- | | Pandas | 0\.0623s | 1x | | **chDB** | **0\.0219s** | **2\.8x** | ## Streaming: Breaking Memory Limits \# What if your query result is too large to fit in memory? chDB supports streaming results:
...
```
Copy command
![The Journey to Zero-Copy_ How chDB Became the Fastest SQL Engine on Pandas DataFrame #1240-5.jpg](/_next/image?url=%2Fuploads%2FThe_Journey_to_Zero_Copy_How_ch_DB_Became_the_Fastest_SQL_Engine_on_Pandas_Data_Frame_1240_5_46732f7a49.jpg&w=2048&q=75)
...
![Journey to Zero-Copy Blog Image.jpg](/_next/image?url=%2Fuploads%2FJourney_to_Zero_Copy_Blog_Image_3135686cb4.jpg&w=2048&q=75)
