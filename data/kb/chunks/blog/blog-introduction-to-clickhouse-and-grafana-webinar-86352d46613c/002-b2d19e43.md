...
than the world’s leading OSS OLAP database and data visualization tool?! ## Finding the data \# For any good analysis, we need good data. Fortunately for us, the data we need is either public or can be generated.
