...
'other' 4ORDER BY price DESC 5LIMIT 1 BY ALL 6LIMIT 10; ``` Copy command And we’ll get back the same set of records. ## Arrow Flight server and client compatibility \# ### Contributed by zakr600, Vitaly Baranov \#
