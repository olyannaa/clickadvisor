...
CPU efficiency. To do this, we turned to detailed profiling, comparing the old and new builds using Linux Perf and flame graphs to visualize where CPU time was being spent. ### Profiling Rotel’s Kafka receiver with flamegraphs \#
...
![rotel-flame-old.png](/_next/image?url=%2Fuploads%2Frotel_flame_old_ab73c122fe.png&w=2048&q=75)

**New:**

![rotel-flame-new.png](/_next/image?url=%2Fuploads%2Frotel_flame_new_b96de94460.png&w=2048&q=75)
