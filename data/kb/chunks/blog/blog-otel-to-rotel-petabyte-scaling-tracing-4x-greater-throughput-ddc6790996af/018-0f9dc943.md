...
row\-oriented RowBinary format to one of the column\-oriented formats, since they may provide another increase in throughput for Rotel. We plan to share our testing results in a future update. #### Further exploring blocking tasks on tokio \#
