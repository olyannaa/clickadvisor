...
Rotel | ClickHouse | | --- | --- | --- | | CPU | 91\.3% | 60\.4% | ![rotel-results-1.png](/_next/image?url=%2Fuploads%2Frotel_results_1_9946792598.png&w=2048&q=75) We continued to search for optimization opportunities, which turned our attention to how we were sending JSON column types.
...
5}
```
Copy commandThe RowBinary encoding for that looks like:

![row-binary-clickhouse.png](/_next/image?url=%2Fuploads%2Frow_binary_clickhouse_60704c5612.png&w=2048&q=75)
