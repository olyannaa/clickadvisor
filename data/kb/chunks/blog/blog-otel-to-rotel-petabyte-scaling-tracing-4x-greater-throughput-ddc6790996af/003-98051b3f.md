...
consumed by a smaller number of collectors that write batch data efficiently to ClickHouse. In the pipeline both Rotel and the OTel Collector support the same Kafka Protobuf encoding, so they are interchangeable ![rotel-pipeline-1.jpg](/_next/image?url=%2Fuploads%2Frotel_pipeline_1_04c5704b11.jpg&w=2048&q=75) ### Evaluation approach \#
