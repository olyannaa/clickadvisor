...
and lets us stream structured data directly to ClickHouse. For example, take the simple JSON object: ``` 1{ 2 "a": 42, 3 "b": "dog", 4 "c": 98 5} ``` Copy commandThe RowBinary encoding for that looks like: ![row-binary-clickhouse.png](/_next/image?url=%2Fuploads%2Frow_binary_clickhouse_60704c5612.png&w=2048&q=75)
