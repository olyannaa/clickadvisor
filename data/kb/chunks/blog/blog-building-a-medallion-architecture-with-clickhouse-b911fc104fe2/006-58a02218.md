...
of the [FINAL operator at query time to ensure zero duplicates in results](https://clickhouse.com/docs/en/guides/replacing-merge-tree#querying-replacingmergetree). Generally, we recommend downstream applications read cautiously from this layer since this clause can incur significant query time overhead. #### Partitioning and data retention \#
...
[![](/_next/image?url=%2Fuploads%2Fdiagram_3_medallion_32a773efdd.png&w=2048&q=75)](/uploads/diagram_3_medallion_32a773efdd.png)
