...
the [FINAL operator](https://clickhouse.com/docs/en/sql-reference/statements/select/from#final-modifier) to ensure that fully deduplicated data is inserted into the Gold layer. This approach ensures the highest data quality while preserving the flexibility to handle advanced query requirements. #### Table design for downstream applications \#
...
[![](/_next/image?url=%2Fuploads%2Fdiagram_5_medallion_f7d71b9a08.png&w=2048&q=75)](/uploads/diagram_5_medallion_f7d71b9a08.png)
