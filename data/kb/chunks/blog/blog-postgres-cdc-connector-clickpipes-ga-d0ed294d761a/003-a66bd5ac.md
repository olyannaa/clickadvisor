...
Postgres CDC to ClickHouse usage over the past year,** [**reference**](https://www.linkedin.com/feed/update/urn:li:activity:7310749593296588800/)**.** ## Product Highlights \# The Postgres CDC connector is purpose\-built for Postgres and ClickHouse and comes with a vast suite of features. Here are a few noteworthy ones:
