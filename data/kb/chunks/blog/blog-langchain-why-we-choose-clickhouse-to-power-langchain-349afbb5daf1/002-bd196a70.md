...
the user experience and ClickHouse Cloud as the service behind their hosted offering. ## What problems does LangSmith solve? \# LangSmith focuses on two primary challenges users encounter when developing LLM applications: Observability and Evaluation. ### Observability \#
...
![observability_langchain_1d1bb59f36.gif](/_next/image?url=%2Fuploads%2Fobservability_langchain_1d1bb59f36_41d2ebc906.gif&w=2048&q=75)
...
![compare_tests_langchain.gif](/_next/image?url=%2Fuploads%2Fcompare_tests_langchain_34c7266fee.gif&w=2048&q=75)
...
![langsmith_workflow.png](/_next/image?url=%2Fuploads%2Flangsmith_workflow_f1fd21a193.png&w=2048&q=75)
