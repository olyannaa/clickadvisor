...
"Ultimately, it was clear that we needed to add another database to complement Postgres for our use case and to unlock real\-time insights for our users."Ankush Gola, co\-founder of LangChain ## What specifically led you to ClickHouse? \#
...
![LLM_Latency.png](/_next/image?url=%2Fuploads%2FLLM_Latency_e9c89c6305.png&w=2048&q=75)
