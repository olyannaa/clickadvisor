...
and see it in action. ### Try Postgres managed by ClickHouse ClickHouse \+ Postgres has become the unified data stack for applications that scale. With Managed Postgres now available in ClickHouse Cloud, this stack is a day\-1 decision.

[Sign up](https://clickhouse.com/cloud/postgres?loc=blog-cta-1162-try-postgres-managed-by-clickhouse-sign-up&utm_blogctaid=1162)### Get started today
