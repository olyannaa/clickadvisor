...
as improving logical type support [\[1]](https://github.com/ClickHouse/ClickHouse/issues/40580) and ensuring Null columns are correctly identified [\[2]](https://github.com/ClickHouse/ClickHouse/issues/46703). For the latest information on Parquet developments, we recommend our monthly release webinars and blogs, or [just watch the issues!](https://github.com/ClickHouse/ClickHouse/issues?q=is%3Aissue+is%3Aopen+Parquet+label%3Afeature) --- Share this post
