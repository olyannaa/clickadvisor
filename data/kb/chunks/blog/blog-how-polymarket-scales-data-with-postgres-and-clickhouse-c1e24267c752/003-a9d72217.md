...
Senior Data Engineer at Polymarket ## Building the data warehouse \# Polymarket uses Hex for dashboarding and data exploration. When these dashboards ran on Postgres, deep analysis was difficult because queries would often run slowly or time out.
