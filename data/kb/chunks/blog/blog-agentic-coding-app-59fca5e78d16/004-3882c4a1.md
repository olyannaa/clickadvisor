...
from natural language, and set myself a simple goal: build a retail analytics platform that I could use in customer meetings, with the full stack running on the ClickHouse data stack. ## Cursor as an AI\-powered IDE \#
