...
0.005 sec. Processed 9.54 thousand rows, 1.14 MB (1.76 million rows/s., 209.01 MB/s.) ``` Any [aggregate function](https://clickhouse.com/docs/en/sql-reference/aggregate-functions/) can be used with State/Merge combinator as a part of an aggregating materialized view. ## Compacting data to optimize storage \#
...
![materialized_view_filter.png](/_next/image?url=%2Fuploads%2Fmaterialized_view_filter_385e36a77d.png&w=2048&q=75)
