...
a complex query must be issued to compute the feature from an aggregation or transformation. ### Identifying features \# Before identifying features, we should be aware of two of the key properties that will influence our modeling process:
