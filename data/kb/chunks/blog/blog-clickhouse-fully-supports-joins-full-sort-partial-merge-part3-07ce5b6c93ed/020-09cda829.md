...
the physical row order of the left table matches the join key sort order, then the in\-memory identification of join matches is more efficient. This diagram sketches the details of how ClickHouse implements the partial merge join: ![partial_merge_1.png](/_next/image?url=%2Fuploads%2Fpartial_merge_1_077d65a57c.png&w=2048&q=75)
