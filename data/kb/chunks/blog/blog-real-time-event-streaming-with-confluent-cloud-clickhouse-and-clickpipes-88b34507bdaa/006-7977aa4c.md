...
topic to the existing table \- the latter has been pre\-created in our case. Users can also create a new table if desired, mapping the message fields to columns of a different name if required. ## Conclusion \#
