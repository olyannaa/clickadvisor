...
![Pub Sub Export(1).png](/_next/image?url=%2Fuploads%2FPub_Sub_Export_1_579ea9c537.png&w=2048&q=75)
...
![Pub Sub Export simplified(1).png](/_next/image?url=%2Fuploads%2FPub_Sub_Export_simplified_1_671841b680.png&w=2048&q=75)
...
```
1CREATE TABLE default.block_messages
2(
3  `MessageData` String,
4  `AttributesMap` Map(String, String)
5)
6ENGINE = MergeTree
7ORDER BY tuple()
8
9SELECT *
10FROM default.block_messages
11LIMIT 1
12FORMAT PrettyJSONEachRow
```
Copy command
