...
no internal holes, we only have a single entry \- allowing us to map our polygons to the simpler Ring type. Our example only includes data for fixed devices. Data for mobile devices also exists for the curious.
...
```
1SELECT SVG([(-160.037841796875, 70.6363054807905), (-160.032348632812, 70.6363054807905), (-160.032348632812, 70.6344840663086), (-160.037841796875, 70.6344840663086), (-160.037841796875, 70.6363054807905)], 'fill: rgb(255, 55,38);') AS svg FORMAT Vertical
2
3Row 1:
4──────
5svg: <polygon points="-160.038,70.6363 -160.032,70.6363 -160.032,70.6345 -160.038,70.6345 -160.038,70.6363" style="fill: rgb(255, 55,38);"/>
6
