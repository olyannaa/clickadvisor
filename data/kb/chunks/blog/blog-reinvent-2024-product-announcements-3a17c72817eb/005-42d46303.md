...
please [contact support](https://clickhouse.com/docs/en/cloud/support) to enable on your cloud service.** ## Vector search using vector similarity indexes (Early Access) \# Last, but certainly not least – we are announcing vector similarity indexes for approximate vector search in early access!
...
![6_reinvent.png](/_next/image?url=%2Fuploads%2F6_reinvent_c6579d4aa9.png&w=2048&q=75)
