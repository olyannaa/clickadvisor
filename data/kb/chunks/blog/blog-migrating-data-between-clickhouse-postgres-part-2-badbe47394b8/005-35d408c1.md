...
via a modified time field. ![postgres_dictionary.png](/_next/image?url=%2Fuploads%2Fpostgres_dictionary_7319d09577.png&w=2048&q=75) Using this dictionary, we can now modify our query and exploit the fact that this table is held locally in memory for fast lookups. Note how we can also avoid the join:
...
![uk_codes.png](/_next/image?url=%2Fuploads%2Fuk_codes_32da86b9b0.png&w=2048&q=75)
...
![postgres_insert_select.png](/_next/image?url=%2Fuploads%2Fpostgres_insert_select_d8dc6cb3c7.png&w=2048&q=75)
