...
optimization**: Replicas were [disabled](https://github.com/ClickHouse/JSONBench/blob/c7afa7078aed72c55ff4441a2da635424fde7724/elasticsearch/config/index_template_no_source_best_compression.json#L44) since we ran Elasticsearch on a single node. - **Optimized rollovers and merges**: We [applied](https://github.com/ClickHouse/JSONBench/blob/c7afa7078aed72c55ff4441a2da635424fde7724/elasticsearch/config/ilm.json#L7) [best practices](https://www.elastic.co/guide/en/elasticsearch/reference/current/size-your-shards.html#shard-size-recommendation) for index rollovers and merges. The next diagram summarises our benchmark configuration of Elasticsearch’s data structures: ![JSON-Benchmarks.014.png](/_next/image?url=%2Fuploads%2FJSON_Benchmarks_014_16218543f4.png&w=2048&q=75)
