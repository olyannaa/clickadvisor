...
traffic; - Egress, where the cost basis depends on which region you egress from and where you egress into; - Ingress, where the cost basis also depends on which region you ingress into and where the remote is.
