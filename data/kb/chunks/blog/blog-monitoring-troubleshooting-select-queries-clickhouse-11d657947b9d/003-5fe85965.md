...
## Most expensive SELECT queries \# We next want to identify the most expensive queries in our ClickHouse service. The query below returns historical queries ordered by their duration, allowing us to see which ones need our attention.
...
![most-expensive-selects.png](/_next/image?url=%2Fuploads%2Fmost_expensive_selects_f5141df105.png&w=2048&q=75)
