...
the computational cost occurs. > Note that if users wish to obtain the complete set of values for a column, they can select "Show More" for a full analysis of the dataset. ### Sampling for Event Patterns \#
...
![](/_next/image?url=%2Fuploads%2Fclickstack_mar2026_image8_9a054085d6.png&w=2048&q=75)
