...
resources or even time out. Chunking constrains each scan lowering memory consumption, and allowing progressive rendering. ## Automatic use of materialized columns \# Another early optimization in ClickStack was the automatic use of [materialized columns for map attributes](https://clickhouse.com/docs/use-cases/observability/clickstack/performance_tuning#materialize-frequently-queried-attributes).
