...
ClickHouse Cloud console, configure the connection details for your MongoDB database, and you’re good to go! For step\-by\-step instructions, frequently asked questions, and gotchas, check out the [documentation for MongoDB ClickPipes](https://clickhouse.com/docs/integrations/clickpipes/mongodb). ### Try the MongoDB CDC connector today
