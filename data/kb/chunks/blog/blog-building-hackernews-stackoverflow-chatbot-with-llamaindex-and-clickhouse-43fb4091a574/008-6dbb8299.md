...
'45-54 years old' = 5, '55-64 years old' = 6, '65 years or older' = 7, 'NA' = 8, 'Prefer not to say' = 9), 39 `annual_salary` Nullable(UInt64) 40) 41ENGINE = MergeTree 42ORDER BY tuple() ``` Copy command
...
```
1INSERT INTO surveys SELECT * FROM s3('https://datasets-documentation.s3.eu-west-3.amazonaws.com/stackoverflow/surveys/2021/surveys-llama.parquet')
```
Copy command
