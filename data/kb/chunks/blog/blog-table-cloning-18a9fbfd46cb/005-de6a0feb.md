...
cloned table still reference them. Underlying column files are only removed once no table (and no running query) references them anymore. ### Instant cloning, independent of table size \# The cloning time is effectively independent of table size.
...
## Copy\-on\-write in action (visual walkthrough) \#
...
![](/_next/image?url=%2Fuploads%2Fclone_tables_feb2026_image3_d323c0323d.png&w=2048&q=75)
...
![](/_next/image?url=%2Fuploads%2Fclone_tables_feb2026_image4_0b8375336b.png&w=2048&q=75)
