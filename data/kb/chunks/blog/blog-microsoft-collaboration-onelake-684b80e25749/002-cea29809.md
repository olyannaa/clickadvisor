...
use the right tool for the job. The ClickHouse integration with OneLake Table APIs exposes Iceberg tables to ClickHouse, allowing users to directly access and analyze their data, facilitating federated and unified analytics across both ClickHouse and Fabric.
