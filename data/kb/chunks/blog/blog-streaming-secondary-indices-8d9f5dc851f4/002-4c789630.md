...
scan the entire index upfront (and may select more data than necessary). ## How streaming secondary indices work \# ClickHouse 25\.9 eliminates these drawbacks by interleaving data reads with index checks, as shown in the animation below: ![Blog-release-25.9-animation-02.gif](/_next/image?url=%2Fuploads%2FBlog_release_25_9_animation_02_1e370aca28.gif&w=2048&q=75)
