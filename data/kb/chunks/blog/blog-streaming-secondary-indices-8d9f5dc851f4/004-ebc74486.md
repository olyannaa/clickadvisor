...
index and processes matching granules in the query engine. ② And as soon as the first matching row (LIMIT 1\) is found, it immediately stops scanning further index entries and granules, eliminating wasted work. ## Key takeaway \#
