...
and `clang` from Android toolchain is patched to account for this. After that, I had to accept I won't be able to use familiar tools, and reluctantly turned to the Android toolchain. ## Using the Android toolchain \#
...
![segfault.jpg](/_next/image?url=%2Fuploads%2Fsegfault_85391a0670.jpg&w=2048&q=75)
