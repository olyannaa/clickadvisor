...
entirely locally. ### Step 5: \+ JSON sub\-column access (`->`, `->>`) \# Commits [`0b4c03e`](https://github.com/ClickHouse/pg_clickhouse/commit/0b4c03e) (April 2, 2026\) and [`669924a`](https://github.com/ClickHouse/pg_clickhouse/commit/669924a) (April 3\), in v0\.1\.6 / v0\.2\.0\. Previously, every `->`/`->>`/`jsonb_extract_path` was a local filter; even `e.properties->>'platform' = 'web'` couldn't pushdown.
