...
as `7 * 86400`. Those mappings live in [src/custom\_types.c](https://github.com/ClickHouse/pg_clickhouse/blob/main/src/custom_types.c), where pg\_clickhouse records the expressions it knows how to translate safely for ClickHouse. The steps outlined below expand that vocabulary from base filters to joins, aggregates, windows, and limits.
