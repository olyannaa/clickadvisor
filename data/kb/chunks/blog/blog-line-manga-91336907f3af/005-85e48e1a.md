...
existing databases or flat files, and run real queries. “You can easily place a list of target users or IDs in a local file, refer to it as a table, and perform joins to output results,” he says.
