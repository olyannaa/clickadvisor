...
parser to parse DDL statements 2. Extracts schema changes (especially column additions) 3. Updates the schema registry 4. Propagates changes to target tables ## **Type Mapping and Conversion** \# ClickPipes handles the full range of MySQL data types:
