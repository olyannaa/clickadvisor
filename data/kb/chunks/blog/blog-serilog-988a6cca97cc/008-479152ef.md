...
our `logs.app_logs` table and a pre\-built dashboard that lights up as soon as the demo generates traffic. ![](/_next/image?url=%2Fuploads%2Fserilog_4_4fa0e50c00.png&w=2048&q=75) The dashboard includes five tiles that demonstrate what you get out of the box with structured log data in ClickHouse:
