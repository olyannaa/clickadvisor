...
across systems, Klaviyo replicates all segment\-relevant data into ClickHouse and computes memberships with a single query. “We just execute the query,” Patrick says, “and we can compute a segment in one second.” ## Optimizing for real\-time performance \#
