...
the geometric mean for target utilization provides important mathematical guarantees: - reversible scaling (same usage returns to same allocation) - balanced headroom in both directions - prevention of allocation drift over time. ### Smoothing out transient spikes \#
