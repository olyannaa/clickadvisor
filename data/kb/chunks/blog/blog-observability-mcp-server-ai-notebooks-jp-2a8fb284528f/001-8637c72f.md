---
source: blog
url: "https://clickhouse.com/blog/clickstack-cloud-private-preview)\u3068\u3057\u3066\
  \u3082\u53D6\u308A\u4E0A\u3052\u308B\u4FA1\u5024\u306E\u3042\u308B\u3082\u306E\u3067\
  \u3057\u305F\u3002\u305D\u308C\u304C\u3001\u30D7\u30E9\u30A4\u30D9\u30FC\u30C8\u30D7\
  \u30EC\u30D3\u30E5\u30FC\u3068\u3057\u3066\u306EClickStack"
topic: open-house-mcp-ai-notebooks-clickstack-cloud
...
## ClickStack Cloud [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#clickstack-cloud)
...
### Managed ClickStackが一般提供開始 [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#managed-clickstack-is-generally-available)
...
## AI Notebooksベータ版 [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#ai-notebooks-in-beta)
...
Loading video...これを構築するにあたり、透明性についてもかなり強いこだわりを持っていました。本番障害の現場では、エンジニアはシステムが実際に何をしているのかを理解する必要があります。とりわけ調査ループにAIが関わっている場合はなおさらです。すべてのクエリ、チャート、推論ステップ、中間結果はノートブック内で可視化されています。クエリを手動で編集したり、独自の検索を追加したり、提案されたパスを完全に無視して調査を別の方向に進めたりすることもできます。私たちは、AIにバックグラウンドでブラックボックス的な結論を出すシステムというよりも、エンジニアの隣に座っている協力者のように振る舞ってほしかったのです。
...
## ClickStack MCPサーバー [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#clickstack-mcp-server)
...
### なぜClickStack専用のMCPなのか? [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#why-a-specialized-clickstack-mcp)
...
### 柔軟性を維持する [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#retaining-flexibility)
...
### 調査だけでなくオーケストレーションも [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#orchestration-not-just-investigation)
...
### MCPの使い方 [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#using-the-mcp)
...
コンテナが起動すると、ClickStack UIは<http://localhost:8080>で利用可能になります。ユーザーを作成してログインしてください。
...
MCPエンドポイントは<http://localhost:8080/api/mcp>で公開されます。
...
## まとめ [\#](/jp/blog/observability-mcp-server-ai-notebooks-jp#conclusion)
...
ClickHouseがあなたのデータでどのように動作するのか興味がありますか?数分でClickHouse Cloudを使い始めることができ、300ドル分の無料クレジットを受け取れます。[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-794-sign-up&utm_blogctaid=794)
