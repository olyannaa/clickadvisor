...
gave [CoalescingMergeTree](/docs/engines/table-engines/mergetree-family/coalescingmergetree) its own spotlight. It’s a new MergeTree engine that physically consolidates sparse updates during background merges, ideal for IoT state, user profiles, and more. [Read the full summer bonus release blog post](/blog/clickhouse-25-6-coalescingmergetree). --- Share this post
