...
before that, [it was already added by calling a subprocess](https://github.com/ClickHouse/ClickHouse/pull/41730), but thanks to the integration with Rust, now we build and link this code into the ClickHouse binary. However, the Rust library [has a bug and crashed](https://github.com/skim-rs/tuikit/pull/51). ![output.gif](/_next/image?url=%2Fuploads%2Foutput_33afc7028f.gif&w=2048&q=75)
...
![SQL example](/_next/image?url=%2Fuploads%2FScreenshot_20250401_002936_8a37cc0fea.png&w=2048&q=75)

An example of the same query in PRQL:
![PRQL example](/_next/image?url=%2Fuploads%2FScreenshot_20250401_003002_c1b621ac20.png&w=2048&q=75)
