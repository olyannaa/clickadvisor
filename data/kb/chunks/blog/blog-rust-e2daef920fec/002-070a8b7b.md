...
We should allow writing new system components in Rust. It should be integrated into the build system, so the Rust code interoperates with C\+\+, and it is built and tested together with no complications. ## First Steps \#
...
![BLAKE3 vs other hash functions](/_next/image?url=%2Fuploads%2FDiagram_ad34f5cbd2_ae41aa9a30.png&w=2048&q=75)
...
![output.gif](/_next/image?url=%2Fuploads%2Foutput_33afc7028f.gif&w=2048&q=75)
