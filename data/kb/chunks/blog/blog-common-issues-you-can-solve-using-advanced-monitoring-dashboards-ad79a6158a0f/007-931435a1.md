...
the queries executed at the time of the peak in the table `system.query_log`. Let’s run a query that shows all the queries executed between 11:20 am and 11:30 am to understand what queries are reading too many rows.
