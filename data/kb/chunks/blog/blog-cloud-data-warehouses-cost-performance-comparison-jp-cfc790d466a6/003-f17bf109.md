...
`低速 & 高コスト` | **Redshift Serverless（128 RPU）** | [\~5,016秒](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/redshift-serverless/results_100B/enriched_100b.json) | [\~$55\.06](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/redshift-serverless/results_100B/enriched_100b.json) | | `低速 & 高コスト` | **Databricks（Large）** | [\~11,821秒](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/databricks/results_100B/clickbench_Large_enriched.json) | [\~$91\.94](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/databricks/results_100B/clickbench_Large_enriched.json) | | `低速 & 高コスト` | **Snowflake（Large）** | [\~21,119秒](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/snowflake/results_100B/large_enriched.json) | [\~$140\.80](https://github.com/ClickHouse/examples/blob/main/blog-examples/Bench2Cost/snowflake/results_100B/large_enriched.json) | *(SnowflakeとDatabricksの最小ウェアハウスサイズはここには示されていません。1000億行では数日間実行されるため、この比較の範囲をはるかに超えています。)* そして[コストパフォーマンススコア](/blog/cloud-data-warehouses-cost-performance-comparison#how-we-measure-overall-cost-performance-ranking)ビューは、ギャップを見逃すことを不可能にします： ![Blog-Costs.015.png](/uploads/Blog_Costs_015_a93e315273.png) 1000億行では、コストパフォーマンスのスプレッドが大幅に増加します：
