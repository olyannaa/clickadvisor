...
offering based on ClickHouse, where you can start building real\-time applications with ease without having to worry about deploying and managing infrastructure. ## Resources [\#](/blog/redshift-vs-clickhouse-comparison#resources) We recommend the following resources with respect to Ethereum and querying this dataset.
