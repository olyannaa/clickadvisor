...
This script can be [packaged and uploaded to AWS Lambda](https://docs.aws.amazon.com/lambda/latest/dg/python-package.html), along with the packaged [`requests`](https://pypi.org/project/requests/) dependency. AWS EventBridge can in turn be configured to schedule the Lambda function at the required interval \- we show this below: [![](/_next/image?url=%2Fuploads%2Fspecify_schedule_7e983c3b37.gif&w=2048&q=75)](/uploads/specify_schedule_7e983c3b37.gif)
