...
``` Copy command We repeated this exercise for each of the tables, recording the timings below. Using this method, we were able to transfer \~1TB and 8\.3 billion rows from Redshift to ClickHouse in less than 35 minutes.
