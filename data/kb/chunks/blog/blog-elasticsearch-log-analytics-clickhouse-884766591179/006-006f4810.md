...
they are part of the engines’ normal execution path. ### Measuring cold runs \# For a cold run, we fully shut down both systems, dropped the Linux page cache, restarted the servers, and only then executed a query.
