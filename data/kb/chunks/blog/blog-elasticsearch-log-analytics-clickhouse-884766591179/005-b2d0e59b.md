...
practices](https://www.elastic.co/docs/reference/elasticsearch/index-lifecycle-actions/ilm-forcemerge)). This improves storage efficiency and does not prevent parallel search execution, because [Lucene can still partition a single segment logically at query time](https://www.elastic.co/search-labs/blog/apache-lucene-10-release-highlights). ### Data loading \# ClickHouse loaded the Parquet files directly using native Parquet ingestion.
