...
infrequent, bulk changes. - **Lightweight updates** via [UPDATE](https://clickhouse.com/docs/sql-reference/statements/update) powered by **patch parts** — these write only the changed column values as compact delta parts, making them far more efficient for frequent or targeted updates. ### Classic mutations \#
...
![sins-06-mutations.png](/_next/image?url=%2Fuploads%2Fsins_06_mutations_647f7d67d9.png&w=2048&q=75)
