...
### Approximate Nearest Neighbour (Annoy) \# ***Note: Annoy indexes are highly experimental in ClickHouse.*** An Annoy index is designed to improve the efficiency of large\-scale nearest\-neighbor vector searches. With it comes a trade\-off between accuracy and computational efficiency.
