...
rows in set. Elapsed: 1227.979 sec. Processed 1.00 trillion rows, 2.51 TB (814.35 million rows/s., 2.05 GB/s.) 14Peak memory usage: 98.90 GiB. ``` Copy command That’s just over 20 minutes, so the improvement this time is around 2\.5x.
