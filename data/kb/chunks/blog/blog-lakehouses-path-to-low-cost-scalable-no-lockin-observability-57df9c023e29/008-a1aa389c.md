...
most of the challenges discussed above in open table formats can be mitigated with the right tools or managed services, there are more fundamental challenges in the Parquet file format for observability. #### Support for semi\-structured data \#
...
![parquet_vs_clickhouse_json.png](/_next/image?url=%2Fuploads%2Fparquet_vs_clickhouse_json_dbfb08a45a.png&w=2048&q=75)
