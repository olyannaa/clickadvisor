...
with additional metadata, such as file\-level and column\-level statistics, these formats enable metadata\-based pruning \- engines can skip entire partitions and files before having to scan Parquet data, reducing both I/O and latency. ### Compaction and sorting \#
...
![iceberg_compaction.png](/_next/image?url=%2Fuploads%2Ficeberg_compaction_4adbb2f602.png&w=2048&q=75)
