...
at insert time, enabling users to query individual keys without having to scan or parse entire objects \- retaining all the compression, indexing, and filtering benefits of native columnar storage. #### For large scans, not small reads \#
