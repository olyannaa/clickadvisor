...
is OpenTelemetry? \# The OpenTelemetry project is a vendor\-neutral open\-source framework consisting of SDKs, APIs, and components that allow the ingesting, transforming, and sending of Observability data to a backend. More specifically, this consists of several main components:
