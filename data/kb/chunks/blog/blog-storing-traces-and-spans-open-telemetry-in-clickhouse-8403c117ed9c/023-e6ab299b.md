...
that users will wish to employ [sampling techniques](https://opentelemetry.io/blog/2022/tail-sampling/). This allows only a subset of traces to be stored, thus reducing hardware requirements. Be aware this [complicates scaling](https://opentelemetry.io/blog/2022/tail-sampling/#limitations-of-opentelemetry). We will address this in a later post. ## Conclusion [\#](/blog/storing-traces-and-spans-open-telemetry-in-clickhouse#conclusion)
