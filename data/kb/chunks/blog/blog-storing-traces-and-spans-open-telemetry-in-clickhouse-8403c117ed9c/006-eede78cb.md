...
the value of `default` (as used in the demo fork). ``` 1CREATE DATABASE otel ``` Copy command - The exporter is in alpha, and users should adhere to the advice [provided by OpenTelemetry](https://github.com/open-telemetry/opentelemetry-collector#alpha). ## Example Application \# ![otel_demo.png](/_next/image?url=%2Fuploads%2Fotel_demo_ab40c40d7f.png&w=2048&q=75)
...
[![](/_next/image?url=%2Fuploads%2Fotel_demo_architecture_4c2b4164ce.png&w=2048&q=75)](/uploads/otel_demo_architecture_4c2b4164ce.png)
...
```
1git clone https://github.com/ClickHouse/opentelemetry-demo.git
2cd opentelemetry-demo/
3docker compose up --no-build
```
Copy command
