...
features, performance improvements, and tooling for the community. Users who choose to run ClickStack self\-managed will continue to have full access to the same open source foundation that powers Managed ClickStack. ## Getting started with Managed ClickStack \#
...
![clickstack-managed.png](/_next/image?url=%2Fuploads%2Fclickstack_managed_356c59dc4f.png&w=2048&q=75)
...
[Start free trial](https://console.clickhouse.cloud/signUp?loc=blog-cta-53-get-started-today-start-free-trial&utm_blogctaid=53)## Why we built managed ClickStack \#
