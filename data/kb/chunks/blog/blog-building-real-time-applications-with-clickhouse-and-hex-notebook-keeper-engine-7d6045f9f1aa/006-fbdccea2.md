...
succeed if it can be done atomically. With these properties in place, we could implement our queue. The full scheduling and worker code can be found [here](https://github.com/ClickHouse/clickhub). We visualize the full process below: ![keeper_map_updates.png](/_next/image?url=%2Fuploads%2Fkeeper_map_updates_578d816540.png&w=2048&q=75) A few important notes:
