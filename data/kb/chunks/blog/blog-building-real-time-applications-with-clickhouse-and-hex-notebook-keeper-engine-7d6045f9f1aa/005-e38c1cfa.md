...
```
1CREATE TABLE git.work_queue
2(
3    `repo_name` String,
4    `scheduled` DateTime,
5    `priority` Int32,
6    `worker_id` String,
7    `started_time` DateTime
8)
9ENGINE = KeeperMap('git_queue')
10PRIMARY KEY repo_name
```
Copy command
...
![keeper_map_updates.png](/_next/image?url=%2Fuploads%2Fkeeper_map_updates_578d816540.png&w=2048&q=75)
