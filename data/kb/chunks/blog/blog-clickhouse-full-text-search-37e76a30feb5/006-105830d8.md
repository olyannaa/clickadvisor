...
``` Copy command #### Why Compression Matters \# The traditional approach for compressing posting lists is to combine: - **Delta encoding** – to calculate the differences between neighboring values. - **Golomb\-Rice encoding** – to compress the deltas efficiently.
...
![Full-text search 19.png](/_next/image?url=%2Fuploads%2FFull_text_search_19_01a4f43a5a.png&w=2048&q=75)
