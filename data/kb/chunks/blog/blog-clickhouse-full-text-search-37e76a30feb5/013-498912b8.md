...
introduces a **new match engine** that’s completely transparent to users. ### **Example** \# Consider the query: ``` SELECT col1, col2 FROM table WHERE searchAny(col3, ['hello']) ``` Copy command #### **Before: Read the text column to match rows** \#
...
![Full-text search 13 (compact).png](/_next/image?url=%2Fuploads%2FFull_text_search_13_compact_fca1fe67ed.png&w=2048&q=75)
...
![Full-text search 12 (compact).png](/_next/image?url=%2Fuploads%2FFull_text_search_12_compact_c3e543b153.png&w=2048&q=75)
