...
the split tokenizer when you need **exact, separator\-based tokenization** and want to preserve multi\-line or unusual token boundaries. ### 3\. Smaller index footprint \# We made major improvements to reduce the memory and disk footprint of text indexes:
