...
projections could be costly due to the high cost per GB of storage. However, with the move to ClickHouse Cloud, and a shift to S3 storage, projections are now available at a much lower cost. ## Summary [\#](/blog/how-messagebird-uses-clickhouse-to-monitor-the-delivery-of-billions-of-messages#summary)
