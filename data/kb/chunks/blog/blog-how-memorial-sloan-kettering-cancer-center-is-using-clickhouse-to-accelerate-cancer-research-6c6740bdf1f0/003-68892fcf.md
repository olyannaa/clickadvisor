...
22,000 genes, with RNA expression data from patient records generating billions of rows. Altogether, these datasets add up to over 4 billion data points. "Our ultimate goal is to support 1 million patients with multiple samples," Aaron says.
