...
else," he says. "Cost savings were just an added benefit." ## Lessons learned along the way \# Having implemented ClickHouse twice now—first at Trieve, now again at Mintlify—Nick has a few recommendations for teams considering a similar move.
