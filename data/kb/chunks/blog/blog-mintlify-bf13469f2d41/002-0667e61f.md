...
than expected. "Prior to using ClickHouse, opening the analytics page in the Mintlify dashboard could take tens of seconds to load," says engineering manager Nicholas Khami. "After using ClickHouse, we've gotten that latency down to sub\-one\-second—it's almost instant."
