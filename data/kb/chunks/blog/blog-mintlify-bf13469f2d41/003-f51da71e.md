...
other options. "DuckDB didn't meet our needs, as we had real\-time analytics that needed to horizontally scale to a larger growing customer base," Nick says. "BigQuery was very expensive and difficult to get started with relative to ClickHouse."
