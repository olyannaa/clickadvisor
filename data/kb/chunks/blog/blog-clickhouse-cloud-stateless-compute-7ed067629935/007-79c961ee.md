...
decoupling database metadata from local disk and enabling truly stateless compute nodes: ![Blog-shared_catalog.004.png](/_next/image?url=%2Fuploads%2FBlog_shared_catalog_004_233b0fd1ce.png&w=2048&q=75) The Shared database engine remains responsible for ① handling all DDL statements and catalog lookups, now backed by the Shared Catalog rather than local files.
