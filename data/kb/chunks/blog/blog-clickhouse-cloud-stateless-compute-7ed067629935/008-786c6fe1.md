...
we had to solve. > > If you’re curious how the magic happens under the hood, read on and enjoy! > If you’re just here for the high\-level takeaways, feel free to [skip ahead](/blog/clickhouse-cloud-stateless-compute#3-provisioning-built-for-speed-and-getting-faster), we won’t be offended.
