...
consists of three main Keeper nodes: - `/uuids`: maps UUIDs to object metadata (e.g. CREATE queries, versions) - `/names`: maps object names to UUIDs (for lookup and rename) - `/replicas`: tracks each compute node’s latest applied metadata version
...
![_blog_animation01.gif](/_next/image?url=%2Fuploads%2Fblog_animation01_22ab77476b.gif&w=2048&q=75)
