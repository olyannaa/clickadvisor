...
disk as a collection of immutable [data parts](https://clickhouse.com/docs/parts). The ReplicatedMergeTree table engine enables high availability by automatically [replicating](https://clickhouse.com/docs/shards#what-are-table-replicas-in-clickhouse) data to other nodes, coordinated via a replication log in Keeper. **③ In\-memory query execution: using the OS page cache**
...
![Blog-shared_catalog.002.png](/_next/image?url=%2Fuploads%2FBlog_shared_catalog_002_2bf35d5d5d.png&w=2048&q=75)
