...
executed against ClickHouse. Beyond these six stories, you can also [explore](https://clickhouse.com/user-stories?useCase=4) how teams including **mpathic, SewerAI, RBC Borealis, poolside, Cognitiv, Lens, DENIC, AdMixer, and DeepL** are using ClickHouse for machine learning and GenAI workloads. ### **Looking ahead** \#
