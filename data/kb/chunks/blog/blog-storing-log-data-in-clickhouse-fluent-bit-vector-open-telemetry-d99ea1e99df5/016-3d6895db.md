...
data which collect similar fields. #### Logs over time by pod name \# Here, we group by a custom interval and use a fill to populate missing groups. Adapt as required. See our [recent blog](https://clickhouse.com/blog/working-with-time-series-data-and-functions-ClickHouse) for further details.
