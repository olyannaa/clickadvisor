...
we expect is the preferred mode of usage: ``` 1uv run --with google-adk adk api_server ``` Copy command 📄 [View the full Google Agent Development Kit example](https://github.com/ClickHouse/examples/tree/main/ai/mcp/google-agent-development-kit) 🧪 [Try the Google Agent Development Kit example](https://github.com/ClickHouse/examples/blob/main/ai/mcp/google-agent-development-kit) ## CrewAI \#
