...
24 ) as agent: 25 query = "Tell me about UK property prices over the last five years" 26 print(f"User: {query}") 27 async for chunk in agent.run_stream(query): 28 print(chunk.text, end="", flush=True) 29 print("nn") 30 31asyncio.run(run_with_mcp()) ``` Copy command
