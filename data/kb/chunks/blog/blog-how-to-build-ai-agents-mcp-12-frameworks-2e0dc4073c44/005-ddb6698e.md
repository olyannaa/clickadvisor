...
to use the Python library, which can be installed using pip: ``` 1pip install claude-agent-sdk ``` Copy command Integrating our ClickHouse MCP server with the Claude Agent SDK is quite simple. Let’s have a look at the code:
