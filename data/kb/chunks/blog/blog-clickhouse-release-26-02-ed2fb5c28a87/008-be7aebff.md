...
only 3 rows per granule in the chart for clarity). ![](/_next/image?url=%2Fuploads%2FScreenshot_2026_03_16_at_11_36_46_a8f2bcc539.png&w=2048&q=75) Based on this granule organization, ClickHouse can apply different pruning techniques to skip entire granules for queries that filter on indexed columns: #### ① Primary index \#
...
### Automatically enabling minmax indexes \#
