...
is almost always `message`. - `id` \- An identifier for the event. - `data` \- A JSON object representing the change itself. We can use cURL at the terminal to stream just the `data` part of each event:
