...
\- tables, views, functions, etc. Each warehouse has a primary service (this service was created first) and secondary service(s). For example, here is a warehouse containing two services: ![compute_compute_02.png](/_next/image?url=%2Fuploads%2Fcompute_compute_02_9bccc649bb.png&w=2048&q=75) Each service in such a warehouse has its own:
...
![compute_compute_04.png](/_next/image?url=%2Fuploads%2Fcompute_compute_04_93c203d689.png&w=2048&q=75)
