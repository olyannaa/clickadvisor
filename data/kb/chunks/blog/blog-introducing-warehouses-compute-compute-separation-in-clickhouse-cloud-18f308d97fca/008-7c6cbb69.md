...
the queries that caused them. ### Warehouses limitations \# Though warehouses bring a lot of flexibility to ClickHouse Cloud, there are a few limitations that are presented in the current implementation and that we plan to remove later:
