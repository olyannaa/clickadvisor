...
services is created, all services belonging to a single WH are grouped together. In the example below, we have two warehouses: - `DWH_pre_prod` has four services - `DWH_for_tests_us_east_1` has only one service: ![compute_compute_04.png](/_next/image?url=%2Fuploads%2Fcompute_compute_04_93c203d689.png&w=2048&q=75) ### Under the hood \#
