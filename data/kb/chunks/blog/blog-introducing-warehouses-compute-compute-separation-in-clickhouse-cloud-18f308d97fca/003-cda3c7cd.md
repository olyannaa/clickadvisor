...
into the cost of their queries, especially if they have idling enabled. ### 3\. Providing different HA level for different workloads \# Some workloads are extremely critical while others can tolerate lower uptime to reduce costs. For example:
...
![compute_compute_01.png](/_next/image?url=%2Fuploads%2Fcompute_compute_01_ba2b32bcdd.png&w=2048&q=75)
...
![compute_compute_02.png](/_next/image?url=%2Fuploads%2Fcompute_compute_02_9bccc649bb.png&w=2048&q=75)
