...
query takes about 0\.1 seconds with just over 4400 (and 4M rows) tests in the database. Without the projection, it takes more than 17 seconds. ## Looking forward, what's next for you (and your use of ClickHouse)? \#
