...
o11y interface for ClickHouse**. This needs to be developer\-friendly, open, and accessible, while giving direct access to the underlying database when required. Crucially, it should be open source to avoid just more vendor lock\-in. ## Why ClickStack \#
...
![hyperdx_ui.png](/_next/image?url=%2Fuploads%2Fhyperdx_ui_7729b66577.png&w=2048&q=75)
