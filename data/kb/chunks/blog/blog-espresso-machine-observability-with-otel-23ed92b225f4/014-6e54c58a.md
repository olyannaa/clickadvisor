...
espresso machine was a toy problem with a real stack. Everything here, the OTLP modeling, the custom collector, the columnar storage, the agent on top, is the same shape as instrumenting anything that matters. It just smells better.
...
[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-1440-get-started-today-sign-up&utm_blogctaid=1440)### Get started today
