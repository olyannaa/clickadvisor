...
**TL;DR** > > > Standard SQL UPDATEs come to ClickHouse: up to **1,000× faster** than mutations thanks to lightweight patch‑part updates. **This post is part of our series on fast UPDATEs in ClickHouse:** - **[Part 1: Purpose\-built engines](https://clickhouse.com/blog/updates-in-clickhouse-1-purpose-built-engines)**
