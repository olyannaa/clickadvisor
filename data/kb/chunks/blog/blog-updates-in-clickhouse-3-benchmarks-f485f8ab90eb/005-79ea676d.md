...
its changes are visible to queries**, comparing all three methods. We also show **how much faster (in %) lightweight updates are** relative to classic mutations, which must finish rewriting the affected data parts before queries see the changes.
...
![Blog-updates Part 3.001.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_3_001_9bb4cf35e5.png&w=2048&q=75)
