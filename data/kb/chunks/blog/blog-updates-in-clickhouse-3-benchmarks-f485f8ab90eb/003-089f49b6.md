...
we’ll **introduce the dataset and benchmark setup**, then go through the results. ## Dataset and benchmark setup \# ### Dataset \# In [Part 1](https://clickhouse.com/blog/updates-in-clickhouse-1-purpose-built-engines) and [Part 2](https://clickhouse.com/blog/updates-in-clickhouse-2-sql-style-updates), we used a small orders table to illustrate basic update scenarios.
