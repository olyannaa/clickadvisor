...
aggregation\-heavy queries that scan millions or billions of rows. In this context, effective **query pushdown** is the central challenge, not just for filtering, but for aggregation in particular. ## pg\_clickhouse is the fastest Postgres extension on ClickBench \#
...
![Screenshot comparing the ClickBench performance of pg_clickhouse to ClickHouse on both arm64 (c8g) and amd64 (c6a) servers.](/_next/image?url=%2Fuploads%2Fclickbench_2026_02_02_c689143402.png&w=2048&q=75)
...
[Get access](https://clickhouse.com/cloud/postgres?loc=blog-cta-1557-try-postgres-managed-by-clickhouse-get-access&utm_blogctaid=1557)
