...
process is visualized below, with an indication of the relevant log file at each stage. ![insert_logs.png](/_next/image?url=%2Fuploads%2Finsert_logs_c3f274c6c6.png&w=2048&q=75) We can use the query below to review how many (and how often) new parts are created during the last two hours.
...
![part_log.png](/_next/image?url=%2Fuploads%2Fpart_log_3121218d57.png&w=2048&q=75)
...
![async_query_log.png](/_next/image?url=%2Fuploads%2Fasync_query_log_f39c1dc4eb.png&w=2048&q=75)
...
![bulk_inserts.png](/_next/image?url=%2Fuploads%2Fbulk_inserts_a5f675e69a.png&w=2048&q=75)
