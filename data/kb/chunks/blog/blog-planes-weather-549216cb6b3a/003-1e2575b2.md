...
data for airplanes at least at 10,000 feet and map the difference between the `altitude` and `geometric_altitude` for a certain day: [![pressure.png](/_next/image?url=%2Fuploads%2Fpressure_4c97106659.png&w=2048&q=75)](https://adsb.exposed/?dataset=Planes&zoom=5&lat=37.1785&lng=-95.2295&query=d095cd7b312291b682d3c9f1dafad188) This looks surprisingly beautiful! Even more interesting, the picture changes if you select a different day.
...
[![crabbing.png](/_next/image?url=%2Fuploads%2Fcrabbing_319dc835ee.png&w=2048&q=75)](https://adsb.exposed/?dataset=Planes&zoom=5&lat=45.4119&lng=4.8697&query=6b7872ee6c34260ef470f5fd675f7d58)
...
```
1positiveModulo(track_degrees - aircraft_true_heading + 180, 360) - 180 AS drift_angle,
```
Copy command
...
```
1sqrt(
2    pow(ground_speed, 2) + pow(aircraft_tas, 2) -
3    2 * ground_speed * aircraft_tas * cos(radians(drift_angle))
4) AS wind_speed,
```
Copy command
