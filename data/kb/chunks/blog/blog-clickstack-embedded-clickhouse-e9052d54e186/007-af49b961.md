...
environment for learning the product, running demos, training teams, experimenting with queries, and understanding how ClickHouse behaves during development. We look forward to seeing how the community uses it, and contributes to its evolution. ### Get started today

Interested in seeing how ClickHouse works on your data? Get started with ClickHouse Cloud in minutes and receive $300 in free credits.

[Sign up](https://console.clickhouse.cloud/signUp?loc=blog-cta-1431-get-started-today-sign-up&utm_blogctaid=1431)
