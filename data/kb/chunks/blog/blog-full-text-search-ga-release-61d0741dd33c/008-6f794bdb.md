...
```
1┌─name───────┬─type─────────┬─compressed_bytes─┬─uncompressed_bytes─┐
21. │ fts_body   │ text         │ 215.84 GiB       │ 223.13 GiB         │
32. │ bloom_body │ bloom_filter │ 7.04 GiB         │ 7.24 GiB           │
4   └────────────┴──────────────┴──────────────────┴────────────────────┘
5
62 rows in set. Elapsed: 0.003 sec.
```
Copy command
