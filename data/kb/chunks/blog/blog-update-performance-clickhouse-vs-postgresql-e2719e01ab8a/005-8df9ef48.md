...
LTS**. #### ClickHouse version \# We performed all tests with **ClickHouse 25\.7** with a default installation without any optimizations applied. #### PostgreSQL version \# We used **PostgreSQL 17\.5** and [installed it with optimized settings](https://github.com/ClickHouse/examples/blob/ec031e87ec602da81fb844d81757ee9f1e912b57/blog-examples/UPDATEBench/postgresql/scripts/benchmark.sh#L15). ### Benchmark methodology \#
...
![Blog-updates Part 4.001.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_4_001_1ee0bc6501.png&w=2048&q=75)
