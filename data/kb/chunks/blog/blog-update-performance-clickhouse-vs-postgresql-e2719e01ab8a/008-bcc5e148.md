...
upd` and `Cols upd` columns indicate how many rows and how many of the 16 table columns were updated in each statement. ![Blog-updates Part 4.003.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_4_003_7338308ff0.png&w=2048&q=75) *(See the raw benchmark results for [PostgreSQL](https://github.com/ClickHouse/examples/blob/ec031e87ec602da81fb844d81757ee9f1e912b57/blog-examples/UPDATEBench/postgresql/results/cold_bulk.json) and [ClickHouse](https://github.com/ClickHouse/examples/blob/ec031e87ec602da81fb844d81757ee9f1e912b57/blog-examples/UPDATEBench/clickhouse/results/update_timings_sequential_lightweight_p20_COLD_BULK.json) behind the chart above.)*
...
![Blog-updates Part 4.004.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_4_004_da3420b9b0.png&w=2048&q=75)
