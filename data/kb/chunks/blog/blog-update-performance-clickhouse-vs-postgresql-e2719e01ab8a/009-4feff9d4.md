...
runs. Each query touches at least the updated rows and columns, but many scan broader data for realistic analytics. The next chart shows post\-update [cold](/blog/update-performance-clickhouse-vs-postgresql#benchmark-methodology) query times for all 10 queries after each bulk\-row UPDATE: ![Blog-updates Part 4.004.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_4_004_da3420b9b0.png&w=2048&q=75)
...
![Blog-updates Part 4.005.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_4_005_4a7fed56c6.png&w=2048&q=75)
