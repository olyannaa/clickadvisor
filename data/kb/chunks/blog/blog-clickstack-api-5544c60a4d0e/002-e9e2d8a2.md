...
spec can also be [downloaded directly](https://api.clickhouse.cloud/v1) for SDK generation or to import into tools like [Postman](https://www.postman.com/) for interactive exploration. ## **What you can do now** \# The API covers the core resources teams need to manage ClickStack programmatically:
...
```
1https://api.clickhouse.cloud/v1/organizations/{organizationId}/services/{serviceId}/clickstack/...
```
Copy command
