...
pointer to Rust byte array type in the beginning takes almost no time, because convertion of pointer to string is intended to be 0\-cost and convertion to byte array has a constant cost in Rust. ## Problems \#
