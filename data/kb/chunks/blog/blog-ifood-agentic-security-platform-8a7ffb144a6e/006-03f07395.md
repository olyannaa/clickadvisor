...
is to capture every request hitting iFood applications. As Jesus sees it, “What we’ve done here shows the potential, the savings, and the performance that ClickHouse can one day bring to the whole company.” --- Share this post
