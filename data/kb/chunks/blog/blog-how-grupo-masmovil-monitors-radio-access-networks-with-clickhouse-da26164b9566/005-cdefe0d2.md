...
both KPIs and the network topology. But consider this, if we had a high\-speed OLAP database we would only need the raw counters for cells tagged (adding columns) with the rest of the topology, just like this: ![masmovil-04.png](/_next/image?url=%2Fuploads%2Fmasmovil_04_cb31fc09ff.png&w=2048&q=75)
