...
incidents, but also create dashboards, persist searches, and validate that the resulting artifacts contain the required evidence and visualizations. In practice, investigations naturally evolve into persistent operational artifacts rather than disposable chat histories. ### Using the MCP \#
...
![](/_next/image?url=%2Fuploads%2Fclickstack_cloud_may2026_image9_be45abcb79.png&w=2048&q=75)
...
```
1Added HTTP MCP server clickstack with URL: http://localhost:8080/api/mcp to local config
2Headers: {
3  "Authorization": "Bearer &lt;your-api-key&gt;"
4}
5File modified: /Users/demo_user/.claude.json [project: /Users/demo_user]
```
Copy command
...
![](/_next/image?url=%2Fuploads%2Fclickstack_cloud_may2026_image10_ad26cd5f59.png&w=2048&q=75)
...
![](/_next/image?url=%2Fuploads%2Fclickstack_cloud_may2026_image11_d6a8f4ef67.png&w=2048&q=75)
