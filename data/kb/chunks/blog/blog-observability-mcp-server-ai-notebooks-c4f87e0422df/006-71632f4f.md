...
model high\-leverage semantic investigation tools instead of forcing it to generate every workflow from raw SQL alone. ### Retaining flexibility \# At the same time, we do not think structured investigative tools should completely replace direct SQL access.
