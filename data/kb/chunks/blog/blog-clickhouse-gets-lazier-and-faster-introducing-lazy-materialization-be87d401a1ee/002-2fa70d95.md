...
begin by describing the core I/O\-saving techniques ClickHouse already uses, then run a real\-world query through them, layer by layer, until lazy materialization kicks in and changes everything. ## The building blocks of I/O efficiency in ClickHouse \#
