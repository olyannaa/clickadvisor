...
layout for object storage \# The dictionary is the part of the text index that stores all indexed tokens, and for each token a reference to a corresponding posting list, representing all row positions that contain the token.
...
![Rethinking full-text search for object storage #1514 Open.png](/_next/image?url=%2Fuploads%2FRethinking_full_text_search_for_object_storage_1514_Open_e0eee154ef.png&w=2048&q=75)
