...
the second half, we move from implementation details to configuration and usage. *For a high\-level overview of full\-text search in ClickHouse and when to use it, see our [GA announcement](https://clickhouse.com/blog/full-text-search-ga-release).* ## Design of the new text index \#
...
![Blog-FTS_v3.001.png](/_next/image?url=%2Fuploads%2FBlog_FTS_v3_001_52473058de.png&w=2048&q=75)
