...
and tokenizer used for the index column, or as an array of already processed tokens to which no preprocessing/tokenization will be applied prior to searching. ### Example — token search \# Creating and populating the table and index.
