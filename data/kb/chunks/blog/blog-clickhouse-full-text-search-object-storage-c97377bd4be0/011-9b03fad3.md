...
posting lists file. We then retrieve that posting list. ![Rethinking full-text search for object storage #1514 Open (9).png](/_next/image?url=%2Fuploads%2FRethinking_full_text_search_for_object_storage_1514_Open_9_82cf0a82e3.png&w=2048&q=75) The retrieved posting list contains the matching row numbers. The engine must now decide how to apply them during execution.
...
![Rethinking full-text search for object storage #1514 Open (10).png](/_next/image?url=%2Fuploads%2FRethinking_full_text_search_for_object_storage_1514_Open_10_5373ab657b.png&w=2048&q=75)
