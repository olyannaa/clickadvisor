...
but don’t require the horsepower of a server. With Python, often the language of choice for these tasks, chDB provides a first\-class integration and allows users to exploit ClickHouse from within their code. ## Why Embed ClickHouse? \#
...
![diagram python and clickhouse.png](/_next/image?url=%2Fuploads%2Fdiagram_python_and_clickhouse_ca71a43efd.png&w=2048&q=75)
