...
chdb.query( 4 f"SELECT town, district, count() AS c, round(avg(price)) AS price " 5 f"FROM s3('https://datasets-documentation.s3.eu-west-3.amazonaws.com/uk-house-prices/csv/house_prices.csv.gz') " 6 f"GROUP BY town, district HAVING c >= 100 ORDER BY price DESC LIMIT 10", 7 "ArrowTable") 8 9print(res) ``` Copy command
...
5price: double
6----
7town: [[4C4F4E444F4E,4C4F4E444F4E,4C4F4E444F4E,56495247494E4941205741544552,4C45415448455248454144,4C4F4E444F4E,4E4F525448574F4F44,57494E44534F52,57494E444C455348414D,434F4248414D]]
8district: [[43495459204F46204C4F4E444F4E,43495459204F4620574553544D494E53544552,4B454E53494E47544F4E20414E44204348454C534541,52554E4E594D454445,454C4D425249444745,43414D44454E,544852454520524956455253,425241434B4E454C4C20464F52455354,535552524559204845415448,454C4D425249444745]]
9c: [[729,9605,6549,379,262,7399,150,111,232,925]]
10price: [[3212987,2888615,2447372,2115944,2085028,1619476,1493810,1360590,1323741,1307596]]
```
Copy command
