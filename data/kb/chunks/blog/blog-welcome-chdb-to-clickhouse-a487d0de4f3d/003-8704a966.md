...
of SQL query results are inevitable. 3. Integration with Python is limited, making it difficult to implement Python UDFs and support SQL on Pandas DataFrame. Most important to the team, it lacked elegance ???? ![diagram python and clickhouse.png](/_next/image?url=%2Fuploads%2Fdiagram_python_and_clickhouse_ca71a43efd.png&w=2048&q=75)
...
![diagram chdb.png](/_next/image?url=%2Fuploads%2Fdiagram_chdb_fd55f6f388.png&w=2048&q=75)
...
1import chdb
2
3data = chdb.query("SELECT * FROM s3('https://datasets-documentation.s3.eu-west-3.amazonaws.com/uk-house-prices/parquet/house_prices_2*.parquet') LIMIT 5","CSVWithNames")
4print(data)
```
Copy command

```
1"price","date","postcode1","postcode2","type","is_new","duration","addr1","addr2","street","locality","town","district","county"
262000,9339,"SS6","8PN",2,0,1,"50","","CHURCH ROAD","RAYLEIGH","RAYLEIGH","ROCHFORD","ESSEX"
353500,9400,"SS6","8PW",2,0,1,"10","","LODGE CLOSE","RAYLEIGH","RAYLEIGH","ROCHFORD","ESSEX"
455950,9430,"SS6","8PX",2,0,1,"56","","GROVE ROAD","RAYLEIGH","RAYLEIGH","ROCHFORD","ESSEX"
550000,9198,"SS6","8PX",2,0,1,"58","","GROVE ROAD","RAYLEIGH","RAYLEIGH","ROCHFORD","ESSEX"
6109995,9152,"SS6","8PY",3,1,1,"18","","THE RAMPARTS","RAYLEIGH","RAYLEIGH","ROCHFORD","ESSEX"
```
Copy command
...
```
1pip install pyarrow pandas matplotlib
```
Copy command
