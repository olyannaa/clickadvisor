...
billion rows, 31.03 GB (95.23 million rows/s., 2.29 GB/s.) 29Peak memory usage: 26.40 MiB. ``` Copy command If you want to run through this comparison yourself, head over to our [getting started guide](https://clickhouse.com/docs/use-cases/data-lake/getting-started) to run through this yourself.
