...
***Speakers:*** To be announced ## ClickHouse v22\.10 \# This past month, ClickHouse received its 100,000th commit! You can look for it with `git log`, but first, let’s take a look at the new features in the October release:
