...
feedback! Take a look at the [release webinar slides](https://presentations.clickhouse.com/release_22.10/) and the [recording](https://youtu.be/sz9SES5-mdc), and please upgrade unless you want to stay on a Long Term Support (LTS) release. ## Query of the Month: The purifying effects of obfuscation \#
