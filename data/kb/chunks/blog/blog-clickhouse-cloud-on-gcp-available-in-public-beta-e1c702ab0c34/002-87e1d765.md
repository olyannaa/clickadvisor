...
Memory: 16 GiB - Production: Designed for production environments and workloads that need additional storage and memory - Storage: Unlimited - Memory: 24 GiB\+ total memory ## Feature Highlights \# ClickHouse Cloud on GCP offers the following features:
...
![Getting Started With GCP Beta](/_next/image?url=%2Fuploads%2Fgcp_console_2fe9217226.gif&w=2048&q=75)
