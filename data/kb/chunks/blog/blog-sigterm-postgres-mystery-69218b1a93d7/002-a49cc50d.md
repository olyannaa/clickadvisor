...
1-[ RECORD 1 ]---+--------------------------------------------------------------
2pid             | 5074
3backend_start   | 2025-06-27 14:57:01.458979+05:30
4xact_start      | 2025-06-27 14:57:47.819348+05:30
5wait_event_type |
6wait_event      |
7state           | active
8query           | SELECT * FROM pg_create_logical_replication_slot('demo_slot', 'pgoutput');
```
Copy command
