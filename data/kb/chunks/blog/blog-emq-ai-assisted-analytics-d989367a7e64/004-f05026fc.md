...
data from the edge all the way to the database,” Cheng says, noting that the setup delivers sub\-second analytics, even across public networks. ![User Story EMQ Issue 1209 (1).png](/_next/image?url=%2Fuploads%2FUser_Story_EMQ_Issue_1209_1_d6d2b3001b.png&w=2048&q=75) End\-to\-end data pipeline from edge devices to ClickHouse\-powered analytics.
