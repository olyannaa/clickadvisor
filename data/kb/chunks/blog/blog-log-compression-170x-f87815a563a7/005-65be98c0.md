...
where each significant value (e.g., IP address, request method, URL, status code, user agent) can be stored into its own column. Instead of storing this entire string as one column, we can parse it into individual columns like:

| Column Name | Data Type | Example Value |
| --- | --- | --- |
| remote\_addr | IPv4 | 185\.161\.113\.50 |
| remote\_user | String | user |
| time\_local | DateTime | 2025\-10\-13 10:00:00 |
