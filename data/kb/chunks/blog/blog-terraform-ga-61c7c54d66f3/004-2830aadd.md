...
the provided **Key ID** and a **Key Secret** pair. ![](/_next/image?url=%2Fuploads%2Fterraform_clickpipes_apr2026_image2_c51c42d023.png&w=2048&q=75) **2\.** Next, configure the provider. To keep credentials out of source control, we recommend using [Terraform variables](https://developer.hashicorp.com/terraform/language/values/variables) and a `terraform.tfvars` file that you can add to `.gitignore`: **variables.tf**
