...
key. That means the write\-path difference also shows up later as higher storage cost and more downstream query I/O. Combined with the [order\-of\-magnitude read\-side advantage from our previous study](https://clickhouse.com/blog/cloud-data-warehouses-cost-performance-comparison), ClickHouse leads at both ends of the analytics pipeline.
