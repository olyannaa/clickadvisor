...
710 rows in set. Elapsed: 0.044 sec. Processed 100.08 million rows, 1.20 GB (2.27 billion rows/s., 27.33 GB/s.) 8Peak memory usage: 2.24 MiB. ``` Copy command Note that all \~100 million rows of the hits table got processed.
...
```
110 rows in set. Elapsed: 0.009 sec. Processed 163.84 thousand rows, 4.95 MB (17.48 million rows/s., 528.35 MB/s.)
2Peak memory usage: 917.51 KiB.
3
410 rows in set. Elapsed: 0.009 sec. Processed 163.84 thousand rows, 4.95 MB (18.03 million rows/s., 544.98 MB/s.)
5Peak memory usage: 198.47 KiB.
6
710 rows in set. Elapsed: 0.009 sec. Processed 163.84 thousand rows, 4.95 MB (18.19 million rows/s., 549.68 MB/s.)
8Peak memory usage: 198.47 KiB.
```
Copy command
