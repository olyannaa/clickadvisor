...
will create .tsv files that can be loaded into ClickHouse (or into other DBMS if you dare). ``` For the ClickHouse repository, this generates files of the following sizes in a few minutes as of November 8th, 2022:
