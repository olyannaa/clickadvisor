...
max_insert_threads = 16, min_insert_block_size_rows = 0, min_insert_block_size_bytes = 2083333333, parallel_distributed_insert_select = 2 0 rows in set. Elapsed: 1317.014 sec. Processed 10.14 billion rows, 562.52 GB (7.70 million rows/s., 427.12 MB/s.) Peak memory usage: 47.25 GiB. ``` Copy command
...
![catalogue_lakehouse.png](/_next/image?url=%2Fuploads%2Fs3_queue_4b0b6ca7cb.gif&w=2048&q=75)
