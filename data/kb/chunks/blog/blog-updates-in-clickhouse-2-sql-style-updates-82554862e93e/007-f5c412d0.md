...
(kbd, mouse). These rows are inserted into a data part named `all_1_1_0` (shown in a diagram further below): ``` 1INSERT INTO orders VALUES 2 (1001, 'kbd', 10, 45.00, 0.00), 3 (1001, 'mouse', 6, 25.00, 0.00); ``` Copy command
...
![Blog-updates Part 2.005.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_2_005_1842c7cbff.png&w=2048&q=75)
