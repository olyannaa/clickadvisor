...
10, 45.00, 0.00), 3 (1001, 'mouse', 6, 25.00, 0.00); ``` Copy command This creates a data part [named](https://clickhouse.com/blog/updates-in-clickhouse-1-purpose-built-engines#how-to-read-a-part-name) `all_1_1_0`: ![Blog-updates Part 2.001.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_2_001_8013fe2a98.png&w=2048&q=75) ### UPDATE triggers a mutation \# We update the quantity and discount for the mouse item:
...
![Blog-updates Part 2.002.png](/_next/image?url=%2Fuploads%2FBlog_updates_Part_2_002_e61e7d0c11.png&w=2048&q=75)
