...
│ 0 │ 1 │ 0 │ 0 │ 13// │ ODBCDriver2 │ 0 │ 1 │ 0 │ 0 │ 14// ... 15var result = s.Query("DESCRIBE s3('https://datasets-documentation.s3.eu-west-3.amazonaws.com/house_parquet/house_0.parquet')"); 16Console.WriteLine(result.Text); ``` Copy command Example of using chDB in C\#
