...
in the diagram below) - **How many “credits” are consumed per hour** For example: - **XS → 1 node → 1 credit/hour** - **S → 2 nodes → 2 credits/hour** - **M → 4 nodes → 4 credits/hour**

![Blog-Costs.001.png](/_next/image?url=%2Fuploads%2FBlog_Costs_001_aa09baa628.png&w=2048&q=75)
