...
# Use both projection and raw data in single query \| Altinity® Knowledge Base for ClickHouse® 1. [Queries \& Syntax](/altinity-kb-queries-and-syntax/) 2. partial\-projection\-optimization # Use both projection and raw data in single query
