...
set up grafana dashboards: - [https://github.com/Altinity/clickhouse\-operator/blob/master/docs/prometheus\_setup.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/prometheus_setup.md) - [https://github.com/Altinity/clickhouse\-operator/blob/master/docs/grafana\_setup.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/grafana_setup.md) - [clickhouse\-operator/monitoring\_setup.md at master · Altinity/clickhouse\-operator](https://github.com/Altinity/clickhouse-operator/blob/master/docs/monitoring_setup.md) ## Extra configs There is an admin user by default in the deployment that is used to admin stuff ## KUBECTL chi basic comands:
