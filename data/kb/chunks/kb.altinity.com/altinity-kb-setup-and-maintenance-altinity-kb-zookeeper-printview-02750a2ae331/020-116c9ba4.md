...
`SYSTEM RESTORE REPLICA` command \- it can be done manually, using instruction [https://clickhouse.com/docs/en/engines/table\-engines/mergetree\-family/replication/\#converting\-from\-mergetree\-to\-replicatedmergetree)](https://clickhouse.com/docs/en/engines/table-engines/mergetree-family/replication/#converting-from-mergetree-to-replicatedmergetree%29) , on scale you can try [https://github.com/Altinity/clickhouse\-zookeeper\-recovery](https://github.com/Altinity/clickhouse-zookeeper-recovery) # 10 \- ZooKeeper cluster migration ZooKeeper cluster migrationHere is a plan for ZK 3\.4\.9 (no dynamic reconfiguration):
