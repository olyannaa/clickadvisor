...
access key id and aws secret access key with the corresponding parts of the HMAC key. # 9 \- Kafka engine Kafka engine## librdkafka changelog This changelog tracks the librdkafka version bundled with ClickHouse and notable related fixes.
