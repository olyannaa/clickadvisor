...
url: https://clickhouse.tech/docs/en/operations/server\-configuration\-parameters/settings/\#max\_server\_memory\_usage](https://clickhouse.tech/docs/en/operations/server-configuration-parameters/settings/#max_server_memory_usage
topic: memory-configuration-settings-altinity-knowledge-base-for-clickhouse
