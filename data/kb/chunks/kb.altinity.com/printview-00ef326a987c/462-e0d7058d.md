...
to have several client config files and pass one of them to clickhouse\-client command explicitly References: - <https://clickhouse.com/docs/en/interfaces/cli> # 10 \- Upgrade Upgrade notes.# ClickHouse® Version Upgrade Procedure ## Step\-by\-Step Guide: Normally the upgrade procedure looks like that:
