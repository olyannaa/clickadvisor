...
earlier messages, the earliest available offset will not be 0; instead, it will be 5\. # 4\.9\.3 \- Schema and Formats Schema inference and format\-specific integration details.# 4\.9\.3\.1 \- Inferring Schema from AvroConfluent Messages in Kafka for ClickHouse®
