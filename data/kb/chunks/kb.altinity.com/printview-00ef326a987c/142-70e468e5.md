...
rows in set. Elapsed: 0.047 sec. Processed 737.28 thousand rows, 64.88 MB (15.72 million rows/s., 1.38 GB/s.) ``` Also no improvement :( Outcome: I would use TYPE bloom\_filter GRANULARITY 3\. # 2\.39\.3 \- Skip indexes examples ## bloom\_filter
