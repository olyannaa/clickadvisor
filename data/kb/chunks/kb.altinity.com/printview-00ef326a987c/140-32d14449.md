...
value TYPE minmax GRANULARITY 10; ALTER TABLE skip_idx_outlier MATERIALIZE INDEX value_idx; SELECT count() FROM skip_idx_outlier WHERE value > 15; 1 rows in set. Elapsed: 0.004 sec. ``` # 2\.39\.2 \- Skip index bloom\_filter Example tested with ClickHouse® 20\.8\.17\.25
