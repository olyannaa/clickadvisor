...
2021 - [Machine Learning Forecase (Russian)](https://github.com/ClickHouse/clickhouse-presentations/blob/master/meetup38/forecast.pdf) \- Presentation from 2019 (Meetup 38\) # 2\.29 \- Mutations ALTER UPDATE / DELETE## How to know if `ALTER TABLE … DELETE/UPDATE mutation ON CLUSTER` was finished successfully on all the nodes?
