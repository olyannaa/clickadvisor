...
FROM numbers(100000000) WHERE NOT ignore(third) 1 rows in set. Elapsed: 0.281 sec. Processed 100.03 million rows, 800.21 MB (356.21 million rows/s., 2.85 GB/s.) ``` # 2\.4 \- DISTINCT \& GROUP BY \& LIMIT 1 BY what the difference
