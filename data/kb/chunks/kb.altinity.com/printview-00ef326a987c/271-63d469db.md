...
current_database, hash ORDER BY userCPUms DESC LIMIT 10 FORMAT Vertical; ``` # 5\.33 \- Zookeeper session has expired Zookeeper session has expired > **Q. I get “Zookeeper session has expired” once. What should i do? Should I worry?**
