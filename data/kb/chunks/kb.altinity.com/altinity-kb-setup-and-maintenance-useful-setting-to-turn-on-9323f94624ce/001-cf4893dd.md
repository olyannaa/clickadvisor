...
url: https://clickhouse.com/docs/operations/settings/merge-tree-settings#ttl_only_drop_parts
topic: useful-settings-to-turn-on-defaults-that-should-be-reconsidered-altinity-knowledge-base-for-clickhouse
