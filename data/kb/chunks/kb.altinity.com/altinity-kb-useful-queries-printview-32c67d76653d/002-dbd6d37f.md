...
performance across different time periods > Looks at unique query shapes (by normalized\_query\_hash) which occurred within two different time intervals (“before” and “after”), and returns performance metrics for each query pattern which performed worse in the “after” interval.
