...
url: https://clickhouse.com/docs/en/operations/settings/merge-tree-settings#max-bytes-to-merge-at-max-space-in-pool
topic: number-of-active-parts-in-a-partition-altinity-knowledge-base-for-clickhouse
