...
'ptest') AND active GROUP BY database, table, name ORDER BY size DESC; ``` ### Projection column size > Returns size, compression rate, row counts, and average row size for each projection (“name”), by db and table, and column
