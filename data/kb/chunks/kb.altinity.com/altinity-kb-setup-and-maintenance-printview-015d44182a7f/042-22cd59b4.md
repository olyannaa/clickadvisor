...
to /home/user/jeprof/clickhouse.1756729237.user.pprof.heap Wrote profile to /home/user/jeprof/clickhouse.1756729237.user.pprof.heap ``` ``` cluster :) SYSTEM JEMALLOC DISABLE PROFILE; SYSTEM JEMALLOC DISABLE PROFILE Ok. 0 rows in set. Elapsed: 0.271 sec. ``` # 20 \- Logging Logging configuration and issuesQ. I get errors:
