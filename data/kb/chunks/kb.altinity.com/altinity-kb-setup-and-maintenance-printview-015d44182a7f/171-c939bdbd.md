...
/usr/bin/clickhouse-keeper --config=/etc/clickhouse-keeper/config.xml ``` # 67\.3 \- Install standalone Zookeeper for ClickHouse® on Ubuntu / Debian Install standalone Zookeeper for ClickHouse® on Ubuntu / Debian.## Reference script to install standalone Zookeeper for Ubuntu / Debian Tested on Ubuntu 20\.
