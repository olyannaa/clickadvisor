...
existing system.query\_log table and then CH creates a new table with these settings. This is automatically done in newer versions 21\+. # 57 \- ClickHouse® Replication problems Finding and troubleshooting problems in the `replication_queue`# Common problems \& solutions
