...
reduce the CPU usage will end up with slower queries! ### How to slow down queries to reduce the CPU usage If it is acceptable for you \- please check the following options for limiting the CPU usage:
