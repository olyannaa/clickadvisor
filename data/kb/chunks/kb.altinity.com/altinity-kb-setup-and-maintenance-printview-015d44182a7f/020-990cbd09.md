...
6 \- Altinity Kubernetes Operator For ClickHouse® Altinity Kubernetes Operator For ClickHouse®## Altinity Kubernetes Operator for ClickHouse® Documentation [https://github.com/Altinity/clickhouse\-operator/blob/master/docs/README.md](https://github.com/Altinity/clickhouse-operator/blob/master/docs/README.md) # 7 \- ClickHouse® and different filesystems ClickHouse® and different filesystems.In general ClickHouse® should work with any POSIX\-compatible filesystem.
