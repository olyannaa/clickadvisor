...
clickhouse-disks --disk s3 --query "remove /cluster/database/table/replica1" ``` # 1\.3 \- How much data are written to S3 during mutations Example of how much data ClickHouse® reads and writes to s3 during mutations.## Configuration S3 disk with disabled merges
