...
Native is the best (user 0m1\.945s). TSV / CSV are good in wall time but spend a lot of CPU (user time). # 18 \- IPs/masks IPs/masks### How do I Store IPv4 and IPv6 Address In One Field?
