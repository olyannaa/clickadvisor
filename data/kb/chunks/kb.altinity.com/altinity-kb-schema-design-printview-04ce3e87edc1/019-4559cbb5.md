...
- [JSONExtract to parse many attributes at a time](/altinity-kb-queries-and-syntax/jsonextract-to-parse-many-attributes-at-a-time/) - [JSONAsString and Mat. View as JSON parser](/altinity-kb-schema-design/altinity-kb-jsonasstring-and-mat.-view-as-json-parser/) # 9 \- Pre\-Aggregation approaches ETL vs Materialized Views vs Projections in ClickHouse®## Pre\-Aggregation approaches: ETL vs Materialized Views vs Projections
