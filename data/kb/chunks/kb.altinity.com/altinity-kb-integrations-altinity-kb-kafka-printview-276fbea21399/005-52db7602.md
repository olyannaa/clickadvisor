...
case of debug it’s possible to use another Kafka table with different `consumer_group`, so it wouldn’t affect your main pipeline. # 2 \- Consumption Patterns Message consumption models, replay patterns, and delivery semantics.# 2\.1 \- Exactly once semantics
