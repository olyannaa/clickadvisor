...
url: https://clickhouse.com/docs/en/engines/table\-engines/integrations/rabbitmq\#virtual\-columns](https://clickhouse.com/docs/en/engines/table-engines/integrations/rabbitmq#virtual-columns
topic: rabbitmq-error-handling-altinity-knowledge-base-for-clickhouse
