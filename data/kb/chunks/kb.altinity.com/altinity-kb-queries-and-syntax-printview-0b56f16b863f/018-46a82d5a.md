...
key, 1 marks to read from 1 ranges Spreading mark ranges among streams (default reading) Reading 1 ranges in order from part 20230105-0_17_17_0, approx. 1 rows starting from 0 ``` # 3 \- DateTime64 ## Subtract fractional seconds
