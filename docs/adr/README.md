...
- [ADR-004: No Generative LLM in the Critical Path](./ADR-004-hybrid-llm-modes.md) - Explains why the MVP exposes MCP for AI agents but does not run a generative LLM inside the recommendation path.
